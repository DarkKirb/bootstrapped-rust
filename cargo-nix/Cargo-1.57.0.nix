...
in
{
  ...
  workspace = {
    ...
    clippy = rustPackages.unknown.clippy."0.1.57";
    clippy_lints = rustPackages.unknown.clippy_lints."0.1.57";
    clippy_utils = rustPackages.unknown.clippy_utils."0.1.57";
    ...
    cargo = rustPackages.unknown.cargo."0.58.0";
  ...
  "unknown".cargo."0.58.0" = overridableMkRustCrate (profileName: rec {
    name = "cargo";
    version = "0.58.0";
    registry = "unknown";
  ...
  "unknown".clippy."0.1.57" = overridableMkRustCrate (profileName: rec {
    name = "clippy";
    version = "0.1.57";
    registry = "unknown";
    ...
    dependencies = {
      clippy_lints = rustPackages."unknown".clippy_lints."0.1.57" { inherit profileName; };
    ...
    devDependencies = {
      ...
      clippy_utils = rustPackages."unknown".clippy_utils."0.1.57" { inherit profileName; };
      compiletest_rs = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiletest_rs."0.7.0" { inherit profileName; };
  ...
  "unknown".clippy_lints."0.1.57" = overridableMkRustCrate (profileName: rec {
    name = "clippy_lints";
    version = "0.1.57";
    registry = "unknown";
  ...
  "unknown".clippy_utils."0.1.57" = overridableMkRustCrate (profileName: rec {
    name = "clippy_utils";
    version = "0.1.57";
    registry = "unknown";
  ...
  "registry+https://github.com/rust-lang/crates.io-index".compiletest_rs."0.7.0" = overridableMkRustCrate (profileName: rec {
    name = "compiletest_rs";
    version = "0.7.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "64698e5e2435db061a85e6320af12c30c5fd88eb84b35d2c1e03ce4f143255ca"; };
    features = builtins.concatLists [
      [ "tempfile" ]
      [ "tmp" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".dlmalloc."0.2.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      compiler_builtins = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.49" { inherit profileName; };
      ${ if hostPlatform.isUnix && !(hostPlatform.parsed.cpu.name == "wasm32") then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.103" { inherit profileName; };
      core = rustPackages."unknown".rustc-std-workspace-core."1.99.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".parity-tokio-ipc."0.9.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "futures" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures."0.3.12" { inherit profileName; };
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.103" { inherit profileName; };
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "log" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.14" { inherit profileName; };
  ...
  "unknown".rls."1.41.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      anyhow = rustPackages."registry+https://github.com/rust-lang/crates.io-index".anyhow."1.0.34" { inherit profileName; };
      cargo = rustPackages."unknown".cargo."0.58.0" { inherit profileName; };
      cargo_util = rustPackages."unknown".cargo-util."0.1.1" { inherit profileName; };
      cargo_metadata = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cargo_metadata."0.12.0" { inherit profileName; };
      ${ if rootFeatures' ? "rls/clippy" || rootFeatures' ? "rls/clippy_lints" then "clippy_lints" else null } = rustPackages."unknown".clippy_lints."0.1.57" { inherit profileName; };
  ...
  "unknown".rls-rustc."0.6.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rls/clippy" || rootFeatures' ? "rls-rustc/clippy" || rootFeatures' ? "rls-rustc/clippy_lints" then "clippy_lints" else null } = rustPackages."unknown".clippy_lints."0.1.57" { inherit profileName; };
      env_logger = rustPackages."registry+https://github.com/rust-lang/crates.io-index".env_logger."0.7.1" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_lint_defs."722.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.28" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tikv-jemalloc-sys."0.4.1+5.2.1-patched" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rustc-main/jemalloc" || rootFeatures' ? "rustc-main/tikv-jemalloc-sys" || rootFeatures' ? "rustc-main/tikv-jemallocator" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.103" { inherit profileName; };
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tikv-jemallocator."0.4.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rustc-main/jemalloc" || rootFeatures' ? "rustc-main/tikv-jemallocator" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.103" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.28" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      cfg_if = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."1.0.0" { inherit profileName; };
      pin_project_lite = rustPackages."registry+https://github.com/rust-lang/crates.io-index".pin-project-lite."0.2.4" { inherit profileName; };
      tracing_attributes = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-attributes."0.1.17" { profileName = "__noProfile"; };
      tracing_core = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-core."0.1.21" { inherit profileName; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".tracing-attributes."0.1.17" = overridableMkRustCrate (profileName: rec {
    name = "tracing-attributes";
    version = "0.1.17";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "c4f915eb6abf914599c200260efced9203504c4c37380af10cdf3b7d36970650"; };
    dependencies = {
      proc_macro2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.24" { inherit profileName; };
      quote = rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.7" { inherit profileName; };
      syn = rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."1.0.65" { inherit profileName; };
