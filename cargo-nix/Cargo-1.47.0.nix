...
in
{
  ...
  workspace = {
    ...
    cargo = rustPackages.unknown.cargo."0.48.0";
    ...
    rustfmt-nightly = rustPackages.unknown.rustfmt-nightly."1.4.20";
  ...
  "registry+https://github.com/rust-lang/crates.io-index".addr2line."0.13.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "std/backtrace" || rootFeatures' ? "test/backtrace" then "compiler_builtins" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.32" { inherit profileName; };
  ...
  "unknown".bootstrap."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      cc = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.58" { inherit profileName; };
  ...
  "unknown".cargo."0.48.0" = overridableMkRustCrate (profileName: rec {
    name = "cargo";
    version = "0.48.0";
    registry = "unknown";
  ...
  "unknown".cargo-test-support."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      cargo = rustPackages."unknown".cargo."0.48.0" { inherit profileName; };
      cargo_test_macro = buildRustPackages."unknown".cargo-test-macro."0.1.0" { profileName = "__noProfile"; };
      filetime = rustPackages."registry+https://github.com/rust-lang/crates.io-index".filetime."0.2.12" { inherit profileName; };
      flate2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".flate2."1.0.16" { inherit profileName; };
      git2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".git2."0.13.8" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.32" = overridableMkRustCrate (profileName: rec {
    ...
    buildDependencies = {
      ${ if rootFeatures' ? "alloc/compiler-builtins-c" || rootFeatures' ? "std/compiler-builtins-c" || rootFeatures' ? "test/compiler-builtins-c" then "cc" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.58" { profileName = "__noProfile"; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".curl-sys."0.4.34+curl-7.71.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      libz_sys = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libz-sys."1.0.27" { inherit profileName; };
      ${ if hostPlatform.isUnix && !(hostPlatform.parsed.kernel.name == "darwin") then "openssl_sys" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".openssl-sys."0.9.58" { inherit profileName; };
      ${ if hostPlatform.isWindows then "winapi" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".winapi."0.3.9" { inherit profileName; };
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".dlmalloc."0.1.4" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      compiler_builtins = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.32" { inherit profileName; };
      ${ if hostPlatform.isUnix && !(hostPlatform.parsed.cpu.name == "wasm32") then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.74" { inherit profileName; };
      core = rustPackages."unknown".rustc-std-workspace-core."1.99.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".expect-test."0.1.0" = overridableMkRustCrate (profileName: rec {
    name = "expect-test";
    version = "0.1.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "a3e383741ea1982866572109d1a8c807bd36aad91fca701489fdca56ef92b3b8"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".jemalloc-sys."0.3.2" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rustc-main/jemalloc" || rootFeatures' ? "rustc-main/jemalloc-sys" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.74" { inherit profileName; };
    };
    buildDependencies = {
      ${ if rootFeatures' ? "rustc-main/jemalloc" || rootFeatures' ? "rustc-main/jemalloc-sys" then "cc" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.58" { profileName = "__noProfile"; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".libz-sys."1.0.27" = overridableMkRustCrate (profileName: rec {
    name = "libz-sys";
    version = "1.0.27";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "6ca8894883d250240341478bf987467332fbdd5da5c42426c69a8f93dbc302f2"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "libc" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".mdbook."0.4.2" = overridableMkRustCrate (profileName: rec {
    name = "mdbook";
    version = "0.4.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b75e31ae4eaa0e45e17ee2b6b9e3ed969c3c6ff12bb4c2e352c42493f4ebb706"; };
    features = builtins.concatLists [
      [ "ammonia" ]
      [ "elasticlunr-rs" ]
      [ "search" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".openssl-src."111.10.2+1.1.1g" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "cargo/vendored-openssl" then "cc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.58" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".racer."2.1.37" = overridableMkRustCrate (profileName: rec {
    name = "racer";
    version = "2.1.37";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "db975752fc2c2430b4159d262585f7e45eb9aa43d733bf02c5f2fde512b00bfb"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.2.1" { inherit profileName; };
      clap = rustPackages."registry+https://github.com/rust-lang/crates.io-index".clap."2.33.3" { inherit profileName; };
      ...
      rustc_ast = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast."671.0.0" { inherit profileName; };
      rustc_ast_pretty = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast_pretty."671.0.0" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."671.0.0" { inherit profileName; };
      rustc_errors = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_errors."671.0.0" { inherit profileName; };
      rustc_parse = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_parse."671.0.0" { inherit profileName; };
      rustc_session = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_session."671.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."671.0.0" { inherit profileName; };
    };
  });
  ...
  "unknown".rls."1.41.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      racer = rustPackages."registry+https://github.com/rust-lang/crates.io-index".racer."2.1.37" { inherit profileName; };
      rand = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rand."0.7.3" { inherit profileName; };
      rayon = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rayon."1.3.1" { inherit profileName; };
      regex = rustPackages."registry+https://github.com/rust-lang/crates.io-index".regex."1.3.9" { inherit profileName; };
      ...
      rustfmt_nightly = rustPackages."unknown".rustfmt-nightly."1.4.20" { inherit profileName; };
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.115" { inherit profileName; };
      serde_derive = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_derive."1.0.115" { profileName = "__noProfile"; };
      serde_ignored = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_ignored."0.1.2" { inherit profileName; };
      serde_json = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.57" { inherit profileName; };
  ...
  "unknown".rustbook."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      clap = rustPackages."registry+https://github.com/rust-lang/crates.io-index".clap."2.33.3" { inherit profileName; };
      mdbook = rustPackages."registry+https://github.com/rust-lang/crates.io-index".mdbook."0.4.2" { inherit profileName; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_arena."671.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_arena";
    version = "671.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "4a3941333c39ffa778611a34692244052fc9ba0f6b02dcf019c8d24925707dd6"; };
    dependencies = {
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."671.0.0" { inherit profileName; };
      smallvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".smallvec."1.4.2" { inherit profileName; };
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast."671.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_ast";
    version = "671.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "27c579f7d89e6fc971b433e92bb2b8c65b716d7c797b21de8685945be9455610"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.2.1" { inherit profileName; };
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.11" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."671.0.0" { inherit profileName; };
      rustc_index = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_index."671.0.0" { inherit profileName; };
      rustc_lexer = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_lexer."671.0.0" { inherit profileName; };
      rustc_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."671.0.0" { profileName = "__noProfile"; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_serialize."671.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."671.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast_passes."671.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_ast_passes";
    version = "671.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "f9914fadee461568d19ca2ebaec8699ff898f8ffec9928154659a57ee018e5fd"; };
    dependencies = {
      itertools = rustPackages."registry+https://github.com/rust-lang/crates.io-index".itertools."0.8.2" { inherit profileName; };
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.11" { inherit profileName; };
      rustc_ast = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast."671.0.0" { inherit profileName; };
      rustc_ast_pretty = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast_pretty."671.0.0" { inherit profileName; };
      rustc_attr = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_attr."671.0.0" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."671.0.0" { inherit profileName; };
      rustc_errors = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_errors."671.0.0" { inherit profileName; };
      rustc_feature = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_feature."671.0.0" { inherit profileName; };
      rustc_parse = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_parse."671.0.0" { inherit profileName; };
      rustc_session = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_session."671.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."671.0.0" { inherit profileName; };
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast_pretty."671.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_ast_pretty";
    version = "671.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "2a78c5cc50a2f294d3c4e9131a15676724c9f136d3ed54e9ba419850b6025cb3"; };
    dependencies = {
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.11" { inherit profileName; };
      rustc_ast = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast."671.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."671.0.0" { inherit profileName; };
      rustc_target = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_target."671.0.0" { inherit profileName; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_attr."671.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_attr";
    version = "671.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "a78ce08227d146949755175c0cf710280a4b5bf6ee504c0e3f7ccc30d66fbfd9"; };
    dependencies = {
      rustc_ast = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast."671.0.0" { inherit profileName; };
      rustc_ast_pretty = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast_pretty."671.0.0" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."671.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."671.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_data_structures";
    version = "671.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "9d5ac3735c38d2d0e95991ebcd7eb1618b60e784194a738e0ce2e8d39c39b809"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.2.1" { inherit profileName; };
      cfg_if = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."0.1.10" { inherit profileName; };
      crossbeam_utils = rustPackages."registry+https://github.com/rust-lang/crates.io-index".crossbeam-utils."0.7.2" { inherit profileName; };
      ...
      once_cell = rustPackages."registry+https://github.com/rust-lang/crates.io-index".once_cell."1.4.1" { inherit profileName; };
      parking_lot = rustPackages."registry+https://github.com/rust-lang/crates.io-index".parking_lot."0.10.2" { inherit profileName; };
      rustc_graphviz = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_graphviz."671.0.0" { inherit profileName; };
      rustc_index = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_index."671.0.0" { inherit profileName; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_serialize."671.0.0" { inherit profileName; };
      rustc_hash = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-hash."1.1.0" { inherit profileName; };
      ...
      stacker = rustPackages."registry+https://github.com/rust-lang/crates.io-index".stacker."0.1.11" { inherit profileName; };
      ${ if hostPlatform.isWindows then "winapi" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".winapi."0.3.9" { inherit profileName; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_errors."671.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_errors";
    version = "671.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "5166a95afa6e3b78ccbece4c2f1e163634854297f1147c6fd90e2712ed3fede5"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_expand."671.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_expand";
    version = "671.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "1a0586e83bdfe70eda8393429a8a38ecb529525dd252d787e479af075d3cab08"; };
    dependencies = {
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.11" { inherit profileName; };
      rustc_ast = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast."671.0.0" { inherit profileName; };
      rustc_ast_passes = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast_passes."671.0.0" { inherit profileName; };
      rustc_ast_pretty = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast_pretty."671.0.0" { inherit profileName; };
      rustc_attr = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_attr."671.0.0" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."671.0.0" { inherit profileName; };
      rustc_errors = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_errors."671.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_feature."671.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_feature";
    version = "671.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "48fc3aa8de0737a8c5a4353e6948548f469150d2b5d3eac391843de32c6c6ca2"; };
    dependencies = {
      lazy_static = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lazy_static."1.4.0" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."671.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."671.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_fs_util."671.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_fs_util";
    version = "671.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "59fd3380f4029020b693bbfd5a14ec8c893ec33c5c0063ad2e68e46d3fbd6a1f"; };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_graphviz."671.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_graphviz";
    version = "671.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b54bd98f70e04291bf611151d1fcd4d7770b35f7ec603d301c4aee0d1979cca4"; };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_index."671.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_index";
    version = "671.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "335bfb187a2489a59ee8c67fcf5d1760e9dcdbe0f02025c199a74caa05096b15"; };
    dependencies = {
      arrayvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".arrayvec."0.5.1" { inherit profileName; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_serialize."671.0.0" { inherit profileName; };
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_lexer."671.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_lexer";
    version = "671.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "22e1221f3bfa2943c942cf8da319ab2346887f8757778c29c7f1822cd27b521f"; };
    dependencies = {
      unicode_xid = rustPackages."registry+https://github.com/rust-lang/crates.io-index".unicode-xid."0.2.1" { inherit profileName; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."671.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_macros";
    version = "671.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "8b774df26c4ef513555b3a303cb209f44cf68a9e6a5481b41ac832301c6487cb"; };
    dependencies = {
      proc_macro2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.19" { inherit profileName; };
      quote = rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.7" { inherit profileName; };
      syn = rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."1.0.38" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_parse."671.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_parse";
    version = "671.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "065e632101bdd57a271f38ee7a4d72b5a3d0467ec845104346c284b2c6c69960"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.2.1" { inherit profileName; };
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.11" { inherit profileName; };
      rustc_ast = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast."671.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_serialize."671.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_serialize";
    version = "671.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "0e8c0b704e3dedb97cbb1ac566bbc0ab397ec4a4743098326a8f2230463fd9f9"; };
    dependencies = {
      indexmap = rustPackages."registry+https://github.com/rust-lang/crates.io-index".indexmap."1.5.1" { inherit profileName; };
      smallvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".smallvec."1.4.2" { inherit profileName; };
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_session."671.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_session";
    version = "671.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "dda99ede4e6e260712754f8548b0a175b615686ad393653a3bd11f6c5e41a04e"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.2.1" { inherit profileName; };
      getopts = rustPackages."registry+https://github.com/rust-lang/crates.io-index".getopts."0.2.21" { inherit profileName; };
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.11" { inherit profileName; };
      ...
      rustc_errors = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_errors."671.0.0" { inherit profileName; };
      rustc_feature = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_feature."671.0.0" { inherit profileName; };
      rustc_fs_util = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_fs_util."671.0.0" { inherit profileName; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_serialize."671.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."671.0.0" { inherit profileName; };
      rustc_target = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_target."671.0.0" { inherit profileName; };
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."671.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_span";
    version = "671.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "53453791c2c0b501a921927ce8e305a801eef130920873f8da92d83dad595236"; };
    dependencies = {
      cfg_if = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."0.1.10" { inherit profileName; };
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.11" { inherit profileName; };
      md5 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".md-5."0.8.0" { inherit profileName; };
      rustc_arena = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_arena."671.0.0" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."671.0.0" { inherit profileName; };
      rustc_index = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_index."671.0.0" { inherit profileName; };
      rustc_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."671.0.0" { profileName = "__noProfile"; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_serialize."671.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_target."671.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_target";
    version = "671.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "ac82006fdb31ef44e24e1623f8b72ac2b404ef15ba20b7ebec0df35e5d20bbef"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.2.1" { inherit profileName; };
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.11" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."671.0.0" { inherit profileName; };
  ...
  "unknown".rustc_lexer."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    devDependencies = {
      expect_test = rustPackages."registry+https://github.com/rust-lang/crates.io-index".expect-test."0.1.0" { inherit profileName; };
    };
  });
  ...
  "unknown".rustfmt-nightly."1.4.20" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."671.0.0" { inherit profileName; };
      rustc_errors = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_errors."671.0.0" { inherit profileName; };
      rustc_expand = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_expand."671.0.0" { inherit profileName; };
      rustc_parse = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_parse."671.0.0" { inherit profileName; };
      rustc_session = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_session."671.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."671.0.0" { inherit profileName; };
      rustc_workspace_hack = rustPackages."unknown".rustc-workspace-hack."1.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".stacker."0.1.11" = overridableMkRustCrate (profileName: rec {
    name = "stacker";
    version = "0.1.11";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "a92bc346006ae78c539d6ab2cf1a1532bc657b8339c464877a990ec82073c66f"; };
    dependencies = {
      cfg_if = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."0.1.10" { inherit profileName; };
      libc = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.74" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.19" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      cfg_if = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."0.1.10" { inherit profileName; };
      tracing_attributes = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-attributes."0.1.10" { profileName = "__noProfile"; };
      tracing_core = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing-core."0.1.14" { inherit profileName; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".tracing-attributes."0.1.10" = overridableMkRustCrate (profileName: rec {
    name = "tracing-attributes";
    version = "0.1.10";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "1fe233f4227389ab7df5b32649239da7ebe0b281824b4e84b342d04d3fd8c25e"; };
    dependencies = {
      proc_macro2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.19" { inherit profileName; };
      quote = rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.7" { inherit profileName; };
      syn = rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."1.0.38" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tracing-core."0.1.14" = overridableMkRustCrate (profileName: rec {
    name = "tracing-core";
    version = "0.1.14";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
