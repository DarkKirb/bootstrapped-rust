...
in
{
  ...
  workspace = {
    ...
    cargo = rustPackages.unknown.cargo."0.50.0";
    ...
    rustfmt-nightly = rustPackages.unknown.rustfmt-nightly."1.4.25";
  ...
  "unknown".backtrace."0.3.53" = overridableMkRustCrate (profileName: rec {
    name = "backtrace";
    version = "0.3.53";
    registry = "unknown";
    ...
    dependencies = {
      ...
      object = rustPackages."registry+https://github.com/rust-lang/crates.io-index".object."0.21.1" { inherit profileName; };
  ...
  "unknown".cargo."0.50.0" = overridableMkRustCrate (profileName: rec {
    name = "cargo";
    version = "0.50.0";
    registry = "unknown";
  ...
  "unknown".cargo-test-support."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      cargo = rustPackages."unknown".cargo."0.50.0" { inherit profileName; };
      cargo_test_macro = buildRustPackages."unknown".cargo-test-macro."0.1.0" { profileName = "__noProfile"; };
      filetime = rustPackages."registry+https://github.com/rust-lang/crates.io-index".filetime."0.2.12" { inherit profileName; };
      flate2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".flate2."1.0.16" { inherit profileName; };
      git2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".git2."0.13.12" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".failure."0.1.8" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      backtrace = rustPackages."unknown".backtrace."0.3.53" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".object."0.21.1" = overridableMkRustCrate (profileName: rec {
    name = "object";
    version = "0.21.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "37fd5004feb2ce328a52b0b3d01dbf4ffff72583493900ed15f22d4111c51693"; };
    features = builtins.concatLists [
      [ "coff" ]
      [ "elf" ]
      [ "macho" ]
  ...
  "unknown".rls."1.41.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      rustfmt_nightly = rustPackages."unknown".rustfmt-nightly."1.4.25" { inherit profileName; };
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.115" { inherit profileName; };
      serde_derive = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_derive."1.0.115" { profileName = "__noProfile"; };
      serde_ignored = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_ignored."0.1.2" { inherit profileName; };
      serde_json = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.59" { inherit profileName; };
  ...
  "unknown".rustfmt-nightly."1.4.25" = overridableMkRustCrate (profileName: rec {
