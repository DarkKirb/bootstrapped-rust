...
in
{
  ...
  workspace = {
    ...
    clippy = rustPackages.unknown.clippy."0.1.54";
    clippy_lints = rustPackages.unknown.clippy_lints."0.1.54";
    clippy_utils = rustPackages.unknown.clippy_utils."0.1.54";
    ...
    cargo = rustPackages.unknown.cargo."0.55.0";
    cargo-platform = rustPackages.unknown.cargo-platform."0.1.1";
    cargo-util = rustPackages.unknown.cargo-util."0.1.0";
  ...
  "registry+https://github.com/rust-lang/crates.io-index".addr2line."0.14.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "std/backtrace" || rootFeatures' ? "test/backtrace" then "compiler_builtins" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.45" { inherit profileName; };
      ${ if rootFeatures' ? "std/addr2line" || rootFeatures' ? "std/backtrace" || rootFeatures' ? "test/backtrace" then "gimli" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".gimli."0.23.0" { inherit profileName; };
  ...
  "unknown".alloc."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      compiler_builtins = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.45" { inherit profileName; };
  ...
  "unknown".bootstrap."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      cc = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.68" { inherit profileName; };
  ...
  "unknown".cargo."0.55.0" = overridableMkRustCrate (profileName: rec {
    name = "cargo";
    version = "0.55.0";
    registry = "unknown";
    ...
    dependencies = {
      ...
      cargo_util = rustPackages."unknown".cargo-util."0.1.0" { inherit profileName; };
      ...
      jobserver = rustPackages."registry+https://github.com/rust-lang/crates.io-index".jobserver."0.1.22" { inherit profileName; };
      lazy_static = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lazy_static."1.4.0" { inherit profileName; };
      ...
      num_cpus = rustPackages."registry+https://github.com/rust-lang/crates.io-index".num_cpus."1.13.0" { inherit profileName; };
      opener = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opener."0.4.1" { inherit profileName; };
      ${ if rootFeatures' ? "cargo/openssl" || rootFeatures' ? "cargo/vendored-openssl" then "openssl" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".openssl."0.10.33" { inherit profileName; };
  ...
  "unknown".cargo-util."0.1.0" = overridableMkRustCrate (profileName: rec {
    name = "cargo-util";
    version = "0.1.0";
    registry = "unknown";
  ...
  "unknown".clippy."0.1.54" = overridableMkRustCrate (profileName: rec {
    name = "clippy";
    version = "0.1.54";
    registry = "unknown";
    ...
    dependencies = {
      clippy_lints = rustPackages."unknown".clippy_lints."0.1.54" { inherit profileName; };
  ...
  "unknown".clippy_lints."0.1.54" = overridableMkRustCrate (profileName: rec {
    name = "clippy_lints";
    version = "0.1.54";
    registry = "unknown";
    ...
    dependencies = {
      cargo_metadata = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cargo_metadata."0.12.0" { inherit profileName; };
      clippy_utils = rustPackages."unknown".clippy_utils."0.1.54" { inherit profileName; };
  ...
  "unknown".clippy_utils."0.1.54" = overridableMkRustCrate (profileName: rec {
    name = "clippy_utils";
    version = "0.1.54";
    registry = "unknown";
  ...
  "registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.45" = overridableMkRustCrate (profileName: rec {
    name = "compiler_builtins";
    version = "0.1.45";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "787187ae221adfcda34b03006f1617099e4ae26b50e5a4db282496014ab75837"; };
    features = builtins.concatLists [
    ...
    buildDependencies = {
      ${ if rootFeatures' ? "alloc/compiler-builtins-c" || rootFeatures' ? "std/compiler-builtins-c" || rootFeatures' ? "test/compiler-builtins-c" then "cc" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.68" { profileName = "__noProfile"; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".curl."0.4.36" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if hostPlatform.isUnix && !(hostPlatform.parsed.kernel.name == "darwin") then "openssl_sys" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".openssl-sys."0.9.61" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".dlmalloc."0.2.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      compiler_builtins = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.45" { inherit profileName; };
      ${ if hostPlatform.isUnix && !(hostPlatform.parsed.cpu.name == "wasm32") then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.93" { inherit profileName; };
      core = rustPackages."unknown".rustc-std-workspace-core."1.99.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".jobserver."0.1.22" = overridableMkRustCrate (profileName: rec {
    name = "jobserver";
    version = "0.1.22";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "972f5ae5d1cb9c6ae417789196c803205313edde988685da5e3aae0827b9e7fd"; };
    dependencies = {
      ${ if hostPlatform.isUnix then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.93" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".jsonrpc-client-transports."17.0.0" = overridableMkRustCrate (profileName: rec {
    name = "jsonrpc-client-transports";
    version = "17.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "15b6c6ad01c7354d60de493148c30ac8a82b759e22ae678c8705e9b8e0c566a4"; };
    features = builtins.concatLists [
    ...
    dependencies = {
      ...
      jsonrpc_core = rustPackages."registry+https://github.com/rust-lang/crates.io-index".jsonrpc-core."17.0.0" { inherit profileName; };
      jsonrpc_pubsub = rustPackages."registry+https://github.com/rust-lang/crates.io-index".jsonrpc-pubsub."17.0.0" { inherit profileName; };
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-rustc/ipc" then "jsonrpc_server_utils" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".jsonrpc-server-utils."17.0.0" { inherit profileName; };
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.14" { inherit profileName; };
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-rustc/ipc" then "parity_tokio_ipc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".parity-tokio-ipc."0.8.0" { inherit profileName; };
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.125" { inherit profileName; };
      serde_json = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.59" { inherit profileName; };
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-rustc/ipc" then "tokio" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."0.2.24" { inherit profileName; };
      url = rustPackages."registry+https://github.com/rust-lang/crates.io-index".url."1.7.2" { inherit profileName; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".jsonrpc-core."17.0.0" = overridableMkRustCrate (profileName: rec {
    name = "jsonrpc-core";
    version = "17.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "07569945133257ff557eb37b015497104cea61a2c9edaf126c1cbd6e8332397f"; };
    dependencies = {
      futures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures."0.3.12" { inherit profileName; };
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.14" { inherit profileName; };
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.125" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".jsonrpc-core-client."17.0.0" = overridableMkRustCrate (profileName: rec {
    name = "jsonrpc-core-client";
    version = "17.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "7ac9d56dc729912796637c30f475bbf834594607b27740dfea6e5fa7ba40d1f1"; };
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-rustc/ipc") "ipc")
    ];
    dependencies = {
      futures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures."0.3.12" { inherit profileName; };
      jsonrpc_client_transports = rustPackages."registry+https://github.com/rust-lang/crates.io-index".jsonrpc-client-transports."17.0.0" { inherit profileName; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".jsonrpc-derive."17.0.0" = overridableMkRustCrate (profileName: rec {
    name = "jsonrpc-derive";
    version = "17.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b68ba7e76e5c7796cfa4d2a30e83986550c34404c6d40551c902ca6f7bd4a137"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".jsonrpc-ipc-server."17.0.1" = overridableMkRustCrate (profileName: rec {
    name = "jsonrpc-ipc-server";
    version = "17.0.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "14c4cd89e5ea7e7f0884e828fc35bb83591a371b92439675eae28efa66c24a97"; };
    dependencies = {
      ...
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" then "jsonrpc_core" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".jsonrpc-core."17.0.0" { inherit profileName; };
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" then "jsonrpc_server_utils" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".jsonrpc-server-utils."17.0.0" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" then "parity_tokio_ipc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".parity-tokio-ipc."0.8.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".jsonrpc-pubsub."17.0.0" = overridableMkRustCrate (profileName: rec {
    name = "jsonrpc-pubsub";
    version = "17.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "0c48dbebce7a9c88ab272a4db7d6478aa4c6d9596e6c086366e89efc4e9ed89e"; };
    dependencies = {
      futures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures."0.3.12" { inherit profileName; };
      jsonrpc_core = rustPackages."registry+https://github.com/rust-lang/crates.io-index".jsonrpc-core."17.0.0" { inherit profileName; };
      lazy_static = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lazy_static."1.4.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".jsonrpc-server-utils."17.0.0" = overridableMkRustCrate (profileName: rec {
    name = "jsonrpc-server-utils";
    version = "17.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "f4207cce738bf713a82525065b750a008f28351324f438f56b33d698ada95bb4"; };
    dependencies = {
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "bytes" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytes."0.5.6" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "jsonrpc_core" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".jsonrpc-core."17.0.0" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "tokio" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."0.2.24" { inherit profileName; };
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "tokio_util" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio-util."0.3.1" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".libgit2-sys."0.12.18+1.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      libz_sys = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libz-sys."1.1.2" { inherit profileName; };
      ${ if hostPlatform.isUnix then "openssl_sys" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".openssl-sys."0.9.61" { inherit profileName; };
    };
    buildDependencies = {
      cc = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.68" { profileName = "__noProfile"; };
      pkg_config = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".pkg-config."0.3.18" { profileName = "__noProfile"; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".lsp-codec."0.2.0" = overridableMkRustCrate (profileName: rec {
    name = "lsp-codec";
    version = "0.2.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "d33c83e320715a1e7e0466a53db2238becb2e5c446deff5506abc81aeacc5ec4"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".mdbook."0.4.7" = overridableMkRustCrate (profileName: rec {
    name = "mdbook";
    version = "0.4.7";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "28f6a882f3880ec68e96f60d6b543c34941e2f307ad10e2992e4db9acfe96529"; };
    features = builtins.concatLists [
      [ "ammonia" ]
      [ "elasticlunr-rs" ]
      [ "search" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".mio-named-pipes."0.1.7" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if hostPlatform.isWindows then "log" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.14" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".net2."0.2.36" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      cfg_if = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."0.1.10" { inherit profileName; };
      ${ if hostPlatform.parsed.kernel.name == "redox" || hostPlatform.isUnix || hostPlatform.parsed.kernel.name == "wasi" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.93" { inherit profileName; };
      ${ if hostPlatform.isWindows then "winapi" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".winapi."0.3.9" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".object."0.25.2" = overridableMkRustCrate (profileName: rec {
    name = "object";
    version = "0.25.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "f8bc1d42047cf336f0f939c99e97183cf31551bf0f2865a2ec9c8d91fd4ffb5e"; };
    features = builtins.concatLists [
      [ "archive" ]
      [ "coff" ]
      [ "crc32fast" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".openssl-src."111.15.0+1.1.1k" = overridableMkRustCrate (profileName: rec {
    name = "openssl-src";
    version = "111.15.0+1.1.1k";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b1a5f6ae2ac04393b217ea9f700cd04fa9bf3d93fae2872069f3d15d908af70a"; };
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "cargo/vendored-openssl") "default")
    ];
    dependencies = {
      ${ if rootFeatures' ? "cargo/vendored-openssl" then "cc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.68" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".openssl-sys."0.9.61" = overridableMkRustCrate (profileName: rec {
    ...
    buildDependencies = {
      autocfg = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".autocfg."1.0.0" { profileName = "__noProfile"; };
      cc = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.68" { profileName = "__noProfile"; };
      ${ if rootFeatures' ? "cargo/vendored-openssl" then "openssl_src" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".openssl-src."111.15.0+1.1.1k" { profileName = "__noProfile"; };
      pkg_config = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".pkg-config."0.3.18" { profileName = "__noProfile"; };
      ${ if hostPlatform.parsed.abi.name == "msvc" then "vcpkg" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".vcpkg."0.2.10" { profileName = "__noProfile"; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".parity-tokio-ipc."0.8.0" = overridableMkRustCrate (profileName: rec {
    name = "parity-tokio-ipc";
    version = "0.8.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "fd7f6c69d7687501b2205fe51ade1d7b8797bb3aa141fe5bf13dd78c0483bc89"; };
    dependencies = {
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "futures" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures."0.3.12" { inherit profileName; };
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.93" { inherit profileName; };
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "log" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.14" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "miow" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".miow."0.3.6" { inherit profileName; };
  ...
  "unknown".rls."1.41.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      anyhow = rustPackages."registry+https://github.com/rust-lang/crates.io-index".anyhow."1.0.34" { inherit profileName; };
      cargo = rustPackages."unknown".cargo."0.55.0" { inherit profileName; };
      cargo_util = rustPackages."unknown".cargo-util."0.1.0" { inherit profileName; };
      cargo_metadata = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cargo_metadata."0.12.0" { inherit profileName; };
      ${ if rootFeatures' ? "rls/clippy" || rootFeatures' ? "rls/clippy_lints" then "clippy_lints" else null } = rustPackages."unknown".clippy_lints."0.1.54" { inherit profileName; };
    ...
    devDependencies = {
      difference = rustPackages."registry+https://github.com/rust-lang/crates.io-index".difference."2.0.0" { inherit profileName; };
      futures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures."0.3.12" { inherit profileName; };
      lsp_codec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lsp-codec."0.2.0" { inherit profileName; };
      tempfile = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tempfile."3.2.0" { inherit profileName; };
  ...
  "unknown".rls-ipc."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      jsonrpc_core = rustPackages."registry+https://github.com/rust-lang/crates.io-index".jsonrpc-core."17.0.0" { inherit profileName; };
      jsonrpc_core_client = rustPackages."registry+https://github.com/rust-lang/crates.io-index".jsonrpc-core-client."17.0.0" { inherit profileName; };
      jsonrpc_derive = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".jsonrpc-derive."17.0.0" { profileName = "__noProfile"; };
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" then "jsonrpc_ipc_server" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".jsonrpc-ipc-server."17.0.1" { inherit profileName; };
      rls_data = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rls-data."0.19.1" { inherit profileName; };
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.125" { inherit profileName; };
    };
  });
  ...
  "unknown".rls-rustc."0.6.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rls/clippy" || rootFeatures' ? "rls-rustc/clippy" || rootFeatures' ? "rls-rustc/clippy_lints" then "clippy_lints" else null } = rustPackages."unknown".clippy_lints."0.1.54" { inherit profileName; };
      env_logger = rustPackages."registry+https://github.com/rust-lang/crates.io-index".env_logger."0.7.1" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-rustc/ipc" || rootFeatures' ? "rls-rustc/tokio" then "tokio" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."0.2.24" { inherit profileName; };
    };
  });
  ...
  "unknown".rustbook."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      clap = rustPackages."registry+https://github.com/rust-lang/crates.io-index".clap."2.33.3" { inherit profileName; };
      env_logger = rustPackages."registry+https://github.com/rust-lang/crates.io-index".env_logger."0.7.1" { inherit profileName; };
      mdbook = rustPackages."registry+https://github.com/rust-lang/crates.io-index".mdbook."0.4.7" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."722.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ena = rustPackages."registry+https://github.com/rust-lang/crates.io-index".ena."0.14.0" { inherit profileName; };
      indexmap = rustPackages."registry+https://github.com/rust-lang/crates.io-index".indexmap."1.6.0" { inherit profileName; };
      jobserver_crate = rustPackages."registry+https://github.com/rust-lang/crates.io-index".jobserver."0.1.22" { inherit profileName; };
      libc = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.93" { inherit profileName; };
      measureme = rustPackages."registry+https://github.com/rust-lang/crates.io-index".measureme."9.1.2" { inherit profileName; };
  ...
  "unknown".rustc_codegen_ssa."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      jobserver = rustPackages."registry+https://github.com/rust-lang/crates.io-index".jobserver."0.1.22" { inherit profileName; };
      libc = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.93" { inherit profileName; };
      object = rustPackages."registry+https://github.com/rust-lang/crates.io-index".object."0.25.2" { inherit profileName; };
  ...
  "unknown".std."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "std/addr2line" || rootFeatures' ? "std/backtrace" || rootFeatures' ? "test/backtrace" then "addr2line" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".addr2line."0.14.0" { inherit profileName; };
      alloc = rustPackages."unknown".alloc."0.0.0" { inherit profileName; };
      cfg_if = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."0.1.10" { inherit profileName; };
      compiler_builtins = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.45" { inherit profileName; };
      core = rustPackages."unknown".core."0.0.0" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "std/backtrace" || rootFeatures' ? "std/object" || rootFeatures' ? "test/backtrace" then "object" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".object."0.22.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tikv-jemalloc-sys."0.4.1+5.2.1-patched" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rustc-main/jemalloc" || rootFeatures' ? "rustc-main/tikv-jemalloc-sys" || rootFeatures' ? "rustc-main/tikv-jemallocator" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.93" { inherit profileName; };
    };
    buildDependencies = {
      ${ if rootFeatures' ? "rustc-main/jemalloc" || rootFeatures' ? "rustc-main/tikv-jemalloc-sys" || rootFeatures' ? "rustc-main/tikv-jemallocator" then "cc" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.68" { profileName = "__noProfile"; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tikv-jemallocator."0.4.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rustc-main/jemalloc" || rootFeatures' ? "rustc-main/tikv-jemallocator" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.93" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tokio."0.2.24" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      ...
      [ "io-driver" ]
      [ "io-util" ]
      (lib.optional (rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc") "iovec")
      [ "lazy_static" ]
      [ "libc" ]
      (lib.optional (rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc") "macros")
      [ "memchr" ]
      [ "mio" ]
      [ "mio-named-pipes" ]
      [ "mio-uds" ]
      ...
      [ "process" ]
      [ "rt-core" ]
      (lib.optional (rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc") "rt-threaded")
      [ "rt-util" ]
      [ "signal" ]
      ...
      [ "time" ]
      (lib.optional (rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc") "tokio-macros")
      (lib.optional (rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc") "uds")
      [ "winapi" ]
    ];
    dependencies = {
      bytes = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bytes."0.5.6" { inherit profileName; };
      futures_core = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures-core."0.3.12" { inherit profileName; };
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "iovec" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".iovec."0.1.4" { inherit profileName; };
      lazy_static = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lazy_static."1.4.0" { inherit profileName; };
      ${ if hostPlatform.isUnix then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.93" { inherit profileName; };
      memchr = rustPackages."registry+https://github.com/rust-lang/crates.io-index".memchr."2.4.0" { inherit profileName; };
      ...
      slab = rustPackages."registry+https://github.com/rust-lang/crates.io-index".slab."0.4.2" { inherit profileName; };
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "tokio_macros" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio-macros."0.2.6" { profileName = "__noProfile"; };
      ${ if hostPlatform.isWindows then "winapi" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".winapi."0.3.9" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tokio-macros."0.2.6" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "proc_macro2" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.24" { inherit profileName; };
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "quote" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.7" { inherit profileName; };
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "syn" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."1.0.65" { inherit profileName; };
    };
  });
