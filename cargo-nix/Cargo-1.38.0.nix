...
in
{
  ...
  workspace = {
    ...
    cargo = rustPackages.unknown.cargo."0.39.0";
    crates-io = rustPackages.unknown.crates-io."0.27.0";
    cargo-test-macro = rustPackages.unknown.cargo-test-macro."0.1.0";
    rustdoc-tool = rustPackages.unknown.rustdoc-tool."0.0.0";
    rls = rustPackages.unknown.rls."1.38.0";
    rls-rustc = rustPackages.unknown.rls-rustc."0.6.0";
    rustfmt-nightly = rustPackages.unknown.rustfmt-nightly."1.4.4";
    rustfmt-config_proc_macro = rustPackages.unknown.rustfmt-config_proc_macro."0.1.2";
  ...
  "unknown".alloc."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "alloc/compiler-builtins-c" || rootFeatures' ? "std/compiler-builtins-c") "compiler-builtins-c")
  ...
  "registry+https://github.com/rust-lang/crates.io-index".atty."0.2.11" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if hostPlatform.isUnix then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.60" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".backtrace."0.3.34" = overridableMkRustCrate (profileName: rec {
    name = "backtrace";
    version = "0.3.34";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b5164d292487f037ece34ec0de2fcede2faa162f085dd96d2385ab81b12765ba"; };
    features = builtins.concatLists [
      [ "backtrace-sys" ]
      (lib.optional (rootFeatures' ? "std/backtrace") "compiler_builtins")
      (lib.optional (rootFeatures' ? "std/backtrace") "core")
      [ "dbghelp" ]
      [ "default" ]
      [ "dladdr" ]
      [ "libbacktrace" ]
      [ "libunwind" ]
      (lib.optional (rootFeatures' ? "std/backtrace") "rustc-dep-of-std")
      [ "std" ]
    ];
    dependencies = {
      ...
      ${ if rootFeatures' ? "std/backtrace" then "compiler_builtins" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.18" { inherit profileName; };
      libc = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.60" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "std/backtrace" then "core" else null } = rustPackages."unknown".rustc-std-workspace-core."1.0.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".base64."0.10.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "byteorder" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".byteorder."1.2.7" { inherit profileName; };
    };
  });
  ...
  "unknown".cargo."0.39.0" = overridableMkRustCrate (profileName: rec {
    name = "cargo";
    version = "0.39.0";
    registry = "unknown";
    ...
    dependencies = {
      ...
      crates_io = rustPackages."unknown".crates-io."0.27.0" { inherit profileName; };
      ...
      toml = rustPackages."registry+https://github.com/rust-lang/crates.io-index".toml."0.5.1" { inherit profileName; };
      unicode_width = rustPackages."registry+https://github.com/rust-lang/crates.io-index".unicode-width."0.1.5" { inherit profileName; };
      url = rustPackages."registry+https://github.com/rust-lang/crates.io-index".url."2.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.18" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "alloc/compiler-builtins-c" || rootFeatures' ? "std/compiler-builtins-c") "c")
      (lib.optional (rootFeatures' ? "alloc/compiler-builtins-c" || rootFeatures' ? "std/compiler-builtins-c") "cc")
      [ "compiler-builtins" ]
      [ "core" ]
      [ "default" ]
    ...
    buildDependencies = {
      ${ if rootFeatures' ? "alloc/compiler-builtins-c" || rootFeatures' ? "std/compiler-builtins-c" then "cc" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.35" { profileName = "__noProfile"; };
    };
  });
  ...
  "unknown".crates-io."0.27.0" = overridableMkRustCrate (profileName: rec {
    name = "crates-io";
    version = "0.27.0";
    registry = "unknown";
  ...
  "registry+https://github.com/rust-lang/crates.io-index".dlmalloc."0.1.3" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      compiler_builtins = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.18" { inherit profileName; };
      ${ if hostPlatform.isUnix && !(hostPlatform.parsed.cpu.name == "wasm32") then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.60" { inherit profileName; };
      core = rustPackages."unknown".rustc-std-workspace-core."1.0.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".error-chain."0.12.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      backtrace = rustPackages."registry+https://github.com/rust-lang/crates.io-index".backtrace."0.3.34" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".getrandom."0.1.8" = overridableMkRustCrate (profileName: rec {
    name = "getrandom";
    version = "0.1.8";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "34f33de6f0ae7c9cb5e574502a562e2b512799e32abb801cd1e79ad952b62b49"; };
    features = builtins.concatLists [
      [ "std" ]
    ];
    dependencies = {
      cfg_if = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."0.1.8" { inherit profileName; };
      ${ if hostPlatform.isUnix || hostPlatform.parsed.kernel.name == "redox" || hostPlatform.parsed.kernel.name == "wasi" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.60" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".h2."0.1.25" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "log" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.6" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".jemalloc-sys."0.3.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rustc-main/jemalloc" || rootFeatures' ? "rustc-main/jemalloc-sys" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.60" { inherit profileName; };
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".jsonrpc-core."12.0.0" = overridableMkRustCrate (profileName: rec {
    name = "jsonrpc-core";
    version = "12.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "288dca7f9713710a29e485076b9340156cb701edb46a881f5d0c31aa4f5b9143"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".libc."0.2.60" = overridableMkRustCrate (profileName: rec {
    name = "libc";
    version = "0.2.60";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "d44e80633f007889c7eff624b709ab43c92d708caad982295768a7b13ca3b5eb"; };
    features = builtins.concatLists [
      [ "align" ]
      [ "default" ]
      [ "rustc-dep-of-std" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".lsp-types."0.57.2" = overridableMkRustCrate (profileName: rec {
    name = "lsp-types";
    version = "0.57.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b62b77309737b1e262b3bbf37ff8faa740562c633b14702afe9be85dbcb6f88a"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "proposed" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".markup5ever."0.8.1" = overridableMkRustCrate (profileName: rec {
    ...
    buildDependencies = {
      ...
      serde = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.92" { profileName = "__noProfile"; };
      serde_derive = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_derive."1.0.81" { profileName = "__noProfile"; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".mdbook-linkcheck."0.3.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "env_logger" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".env_logger."0.6.0" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "serde" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.92" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".mime."0.3.13" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "unicase" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".unicase."2.4.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".native-tls."0.2.3" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if (rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck") && (hostPlatform.parsed.kernel.name == "darwin" || hostPlatform.parsed.kernel.name == "ios") then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.60" { inherit profileName; };
      ${ if (rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck") && !(hostPlatform.parsed.kernel.name == "windows" || hostPlatform.parsed.kernel.name == "darwin" || hostPlatform.parsed.kernel.name == "ios") then "log" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.6" { inherit profileName; };
      ...
      ${ if (rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck") && (hostPlatform.parsed.kernel.name == "darwin" || hostPlatform.parsed.kernel.name == "ios") then "tempfile" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tempfile."3.0.5" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".net2."0.2.33" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      cfg_if = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."0.1.8" { inherit profileName; };
      ${ if hostPlatform.parsed.kernel.name == "redox" || hostPlatform.isUnix then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.60" { inherit profileName; };
      ${ if hostPlatform.isWindows then "winapi" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".winapi."0.3.6" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".openssl-src."111.3.0+1.1.1c" = overridableMkRustCrate (profileName: rec {
    name = "openssl-src";
    version = "111.3.0+1.1.1c";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "53ed5f31d294bdf5f7a4ba0a206c2754b0f60e9a63b7e3076babc5317873c797"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".openssl-sys."0.9.43" = overridableMkRustCrate (profileName: rec {
    ...
    buildDependencies = {
      cc = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.35" { profileName = "__noProfile"; };
      ${ if rootFeatures' ? "cargo/vendored-openssl" then "openssl_src" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".openssl-src."111.3.0+1.1.1c" { profileName = "__noProfile"; };
      pkg_config = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".pkg-config."0.3.14" { profileName = "__noProfile"; };
      rustc_version = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc_version."0.2.3" { profileName = "__noProfile"; };
      ${ if hostPlatform.parsed.abi.name == "msvc" then "vcpkg" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".vcpkg."0.2.6" { profileName = "__noProfile"; };
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".polonius-engine."0.9.0" = overridableMkRustCrate (profileName: rec {
    name = "polonius-engine";
    version = "0.9.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "f6b8a5defa2aef9ba4999aaa745fbc01c622ecea35964a306adc3e44be4f3b5b"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".racer."2.1.25" = overridableMkRustCrate (profileName: rec {
    name = "racer";
    version = "2.1.25";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "0727b9d7baaf9e42851145545d7b980b5c1752bd16a4c77c925c5e573d0069d9"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.1.0" { inherit profileName; };
      clap = rustPackages."registry+https://github.com/rust-lang/crates.io-index".clap."2.32.0" { inherit profileName; };
      ...
      syntax = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-syntax."546.0.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rand."0.7.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      getrandom_package = rustPackages."registry+https://github.com/rust-lang/crates.io-index".getrandom."0.1.8" { inherit profileName; };
      ${ if hostPlatform.isUnix then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.60" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rand_core."0.5.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      getrandom = rustPackages."registry+https://github.com/rust-lang/crates.io-index".getrandom."0.1.8" { inherit profileName; };
    };
  });
  ...
  "unknown".rls."1.38.0" = overridableMkRustCrate (profileName: rec {
    name = "rls";
    version = "1.38.0";
    registry = "unknown";
    ...
    dependencies = {
      cargo = rustPackages."unknown".cargo."0.39.0" { inherit profileName; };
      cargo_metadata = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cargo_metadata."0.8.0" { inherit profileName; };
      ...
      home = rustPackages."registry+https://github.com/rust-lang/crates.io-index".home."0.3.3" { inherit profileName; };
      itertools = rustPackages."registry+https://github.com/rust-lang/crates.io-index".itertools."0.8.0" { inherit profileName; };
      jsonrpc_core = rustPackages."registry+https://github.com/rust-lang/crates.io-index".jsonrpc-core."12.0.0" { inherit profileName; };
      lazy_static = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lazy_static."1.3.0" { inherit profileName; };
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.6" { inherit profileName; };
      lsp_types = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lsp-types."0.57.2" { inherit profileName; };
      num_cpus = rustPackages."registry+https://github.com/rust-lang/crates.io-index".num_cpus."1.8.0" { inherit profileName; };
      ordslice = rustPackages."registry+https://github.com/rust-lang/crates.io-index".ordslice."0.3.0" { inherit profileName; };
      racer = rustPackages."registry+https://github.com/rust-lang/crates.io-index".racer."2.1.25" { inherit profileName; };
      rand = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rand."0.6.1" { inherit profileName; };
      rayon = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rayon."1.1.0" { inherit profileName; };
      regex = rustPackages."registry+https://github.com/rust-lang/crates.io-index".regex."1.1.6" { inherit profileName; };
      ...
      rustfmt_nightly = rustPackages."unknown".rustfmt-nightly."1.4.4" { inherit profileName; };
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.92" { inherit profileName; };
      serde_derive = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_derive."1.0.81" { profileName = "__noProfile"; };
      serde_ignored = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_ignored."0.0.4" { inherit profileName; };
      serde_json = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.40" { inherit profileName; };
  ...
  "unknown".rustc."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      polonius_engine = rustPackages."registry+https://github.com/rust-lang/crates.io-index".polonius-engine."0.9.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-arena."546.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-arena";
    version = "546.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "4dc2e1e68b64268c543bfa6e63e3c0d9ea58074c71396f42f76931f35a9287f9"; };
    dependencies = {
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."546.0.0" { inherit profileName; };
      smallvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".smallvec."0.6.10" { inherit profileName; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-graphviz."546.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-graphviz";
    version = "546.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "c108d647ce0dd46477b048eafff5a6273b5652e02d47424b0cd684147379c811"; };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."546.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_data_structures";
    version = "546.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "656771744e0783cb8e4481e3b8b1f975687610aaf18833b898018111a0e0e582"; };
    dependencies = {
      cfg_if = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."0.1.8" { inherit profileName; };
      crossbeam_utils = rustPackages."registry+https://github.com/rust-lang/crates.io-index".crossbeam-utils."0.6.5" { inherit profileName; };
      ...
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.6" { inherit profileName; };
      parking_lot = rustPackages."registry+https://github.com/rust-lang/crates.io-index".parking_lot."0.7.1" { inherit profileName; };
      graphviz = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-graphviz."546.0.0" { inherit profileName; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-serialize."546.0.0" { inherit profileName; };
      rustc_hash = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-hash."1.0.1" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_errors."546.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_errors";
    version = "546.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "e37064f6624bc799bfaa2968b61ee6880926dea2a8bba69f18aef6c8e69c9604"; };
    dependencies = {
      ...
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."546.0.0" { inherit profileName; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-serialize."546.0.0" { inherit profileName; };
      syntax_pos = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-syntax_pos."546.0.0" { inherit profileName; };
      termcolor = rustPackages."registry+https://github.com/rust-lang/crates.io-index".termcolor."1.0.4" { inherit profileName; };
      unicode_width = rustPackages."registry+https://github.com/rust-lang/crates.io-index".unicode-width."0.1.5" { inherit profileName; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_lexer."546.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_lexer";
    version = "546.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "ef5bc0a971823637ea23a857f0ef1467f44b1e05d71968821f83a0abe53e0fe3"; };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."546.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_macros";
    version = "546.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b90037e3336fe8835f468db44d0848ae10d9cc8533ae89b55828883f905b7e80"; };
    dependencies = {
      itertools = rustPackages."registry+https://github.com/rust-lang/crates.io-index".itertools."0.8.0" { inherit profileName; };
      proc_macro2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."0.4.30" { inherit profileName; };
      quote = rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."0.6.12" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_target."546.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_target";
    version = "546.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "cadf9ca07315eab3a7a21f63872f9cc81e250fd6ede0419c24f8926ade73a45d"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.1.0" { inherit profileName; };
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.6" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."546.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-serialize."546.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-serialize";
    version = "546.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "61673783f2089e01033ffa82d1988f55175402071b31253a358292e1624d4602"; };
    dependencies = {
      indexmap = rustPackages."registry+https://github.com/rust-lang/crates.io-index".indexmap."1.0.2" { inherit profileName; };
      smallvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".smallvec."0.6.10" { inherit profileName; };
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-syntax."546.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-syntax";
    version = "546.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "28f3dd1346d5b0269c07a4a78855e309a298ab569c9c1302d4d4f57f8eee4e84"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.1.0" { inherit profileName; };
      lazy_static = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lazy_static."1.3.0" { inherit profileName; };
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.6" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."546.0.0" { inherit profileName; };
      errors = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_errors."546.0.0" { inherit profileName; };
      rustc_lexer = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_lexer."546.0.0" { inherit profileName; };
      rustc_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."546.0.0" { profileName = "__noProfile"; };
      rustc_target = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_target."546.0.0" { inherit profileName; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-serialize."546.0.0" { inherit profileName; };
      syntax_pos = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-syntax_pos."546.0.0" { inherit profileName; };
      scoped_tls = rustPackages."registry+https://github.com/rust-lang/crates.io-index".scoped-tls."1.0.0" { inherit profileName; };
      smallvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".smallvec."0.6.10" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-syntax_pos."546.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-syntax_pos";
    version = "546.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "45e67b526dbda3a0c7dab91c8947d43685e7697f52686a4949da3c179cd7c979"; };
    dependencies = {
      cfg_if = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."0.1.8" { inherit profileName; };
      arena = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-arena."546.0.0" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."546.0.0" { inherit profileName; };
      rustc_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."546.0.0" { profileName = "__noProfile"; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-serialize."546.0.0" { inherit profileName; };
      scoped_tls = rustPackages."registry+https://github.com/rust-lang/crates.io-index".scoped-tls."1.0.0" { inherit profileName; };
  ...
  "unknown".rustc_lexer."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "rustc_lexer/unicode-xid") "unicode-xid")
    ];
    dependencies = {
      ${ if rootFeatures' ? "rustc_lexer/unicode-xid" then "unicode_xid" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".unicode-xid."0.1.0" { inherit profileName; };
    };
  });
  ...
  "unknown".rustfmt-config_proc_macro."0.1.2" = overridableMkRustCrate (profileName: rec {
  ...
  "unknown".rustfmt-nightly."1.4.4" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      syntax_pos = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-syntax_pos."546.0.0" { inherit profileName; };
      rustc_workspace_hack = rustPackages."unknown".rustc-workspace-hack."1.0.0" { inherit profileName; };
      rustfmt_config_proc_macro = buildRustPackages."unknown".rustfmt-config_proc_macro."0.1.2" { profileName = "__noProfile"; };
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.92" { inherit profileName; };
      serde_json = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.40" { inherit profileName; };
      structopt = rustPackages."registry+https://github.com/rust-lang/crates.io-index".structopt."0.2.18" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".security-framework."0.3.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.60" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".socket2."0.3.8" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if hostPlatform.isUnix || hostPlatform.parsed.kernel.name == "redox" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.60" { inherit profileName; };
      ${ if hostPlatform.parsed.kernel.name == "redox" then "syscall" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".redox_syscall."0.1.43" { inherit profileName; };
      ${ if hostPlatform.isWindows then "winapi" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".winapi."0.3.6" { inherit profileName; };
    };
  });
  ...
  "unknown".std."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      ...
      (lib.optional (rootFeatures' ? "std/compiler-builtins-c") "compiler-builtins-c")
    ...
    dependencies = {
      alloc = rustPackages."unknown".alloc."0.0.0" { inherit profileName; };
      ${ if rootFeatures' ? "std/backtrace" then "backtrace" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".backtrace."0.3.34" { inherit profileName; };
      cfg_if = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."0.1.8" { inherit profileName; };
      compiler_builtins = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.18" { inherit profileName; };
      core = rustPackages."unknown".core."0.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".structopt."0.2.18" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      clap = rustPackages."registry+https://github.com/rust-lang/crates.io-index".clap."2.32.0" { inherit profileName; };
      structopt_derive = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".structopt-derive."0.2.18" { profileName = "__noProfile"; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".termion."1.5.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if !(hostPlatform.parsed.kernel.name == "redox") then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.60" { inherit profileName; };
      ${ if hostPlatform.parsed.kernel.name == "redox" then "syscall" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".redox_syscall."0.1.43" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".toml."0.5.1" = overridableMkRustCrate (profileName: rec {
    name = "toml";
    version = "0.5.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b8c96d7873fa7ef8bdeb3a9cda3ac48389b4154f32b9803b4bc26220b677b039"; };
    features = builtins.concatLists [
      [ "default" ]
    ];
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".url."2.0.0" = overridableMkRustCrate (profileName: rec {
    name = "url";
    version = "2.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "77ddaf52e65c6b81c56b7e957c0b1970f7937f21c5c6774c4e56fcb4e20b48c6"; };
    features = builtins.concatLists [
      [ "serde" ]
    ];
    dependencies = {
