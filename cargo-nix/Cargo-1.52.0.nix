...
in
{
  ...
  workspace = {
    ...
    clippy = rustPackages.unknown.clippy."0.1.52";
    clippy_lints = rustPackages.unknown.clippy_lints."0.1.52";
    clippy_utils = rustPackages.unknown.clippy_utils."0.1.52";
    ...
    cargo = rustPackages.unknown.cargo."0.53.0";
    ...
    rustfmt-nightly = rustPackages.unknown.rustfmt-nightly."1.4.36";
  ...
  "registry+https://github.com/rust-lang/crates.io-index".atty."0.2.14" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if hostPlatform.isUnix then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.88" { inherit profileName; };
  ...
  "unknown".bootstrap."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      lazy_static = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lazy_static."1.4.0" { inherit profileName; };
      libc = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.88" { inherit profileName; };
  ...
  "unknown".cargo."0.53.0" = overridableMkRustCrate (profileName: rec {
    name = "cargo";
    version = "0.53.0";
    registry = "unknown";
  ...
  "unknown".cargo-test-support."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      cargo = rustPackages."unknown".cargo."0.53.0" { inherit profileName; };
      cargo_test_macro = buildRustPackages."unknown".cargo-test-macro."0.1.0" { profileName = "__noProfile"; };
      filetime = rustPackages."registry+https://github.com/rust-lang/crates.io-index".filetime."0.2.12" { inherit profileName; };
      flate2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".flate2."1.0.16" { inherit profileName; };
      git2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".git2."0.13.17" { inherit profileName; };
  ...
  "unknown".clippy."0.1.52" = overridableMkRustCrate (profileName: rec {
    name = "clippy";
    version = "0.1.52";
    registry = "unknown";
    ...
    dependencies = {
      clippy_lints = rustPackages."unknown".clippy_lints."0.1.52" { inherit profileName; };
  ...
  "unknown".clippy_lints."0.1.52" = overridableMkRustCrate (profileName: rec {
    name = "clippy_lints";
    version = "0.1.52";
    registry = "unknown";
    ...
    dependencies = {
      cargo_metadata = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cargo_metadata."0.12.0" { inherit profileName; };
      clippy_utils = rustPackages."unknown".clippy_utils."0.1.52" { inherit profileName; };
  ...
  "unknown".clippy_utils."0.1.52" = overridableMkRustCrate (profileName: rec {
    name = "clippy_utils";
    version = "0.1.52";
    registry = "unknown";
  ...
  "registry+https://github.com/rust-lang/crates.io-index".dlmalloc."0.2.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      compiler_builtins = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.39" { inherit profileName; };
      ${ if hostPlatform.isUnix && !(hostPlatform.parsed.cpu.name == "wasm32") then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.88" { inherit profileName; };
      core = rustPackages."unknown".rustc-std-workspace-core."1.99.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".jemalloc-sys."0.3.2" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rustc-main/jemalloc" || rootFeatures' ? "rustc-main/jemalloc-sys" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.88" { inherit profileName; };
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".jsonrpc-ipc-server."17.0.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" then "parking_lot" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".parking_lot."0.11.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".libc."0.2.88" = overridableMkRustCrate (profileName: rec {
    name = "libc";
    version = "0.2.88";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "03b07a082330a35e43f63177cc01689da34fbffa0105e1246cf0311472cac73a"; };
    features = builtins.concatLists [
      [ "align" ]
      [ "default" ]
      [ "rustc-dep-of-std" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".markup5ever."0.10.0" = overridableMkRustCrate (profileName: rec {
    ...
    buildDependencies = {
      ...
      serde = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.118" { profileName = "__noProfile"; };
      serde_derive = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_derive."1.0.118" { profileName = "__noProfile"; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".net2."0.2.36" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      cfg_if = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."0.1.10" { inherit profileName; };
      ${ if hostPlatform.parsed.kernel.name == "redox" || hostPlatform.isUnix || hostPlatform.parsed.kernel.name == "wasi" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.88" { inherit profileName; };
      ${ if hostPlatform.isWindows then "winapi" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".winapi."0.3.9" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".parity-tokio-ipc."0.8.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "futures" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures."0.3.12" { inherit profileName; };
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.88" { inherit profileName; };
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "log" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.11" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".racer."2.1.44" = overridableMkRustCrate (profileName: rec {
    name = "racer";
    version = "2.1.44";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "7972a124e2b24dce35eb19f81eced829faec0e8227a7d744bbb1089934d05399"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.2.1" { inherit profileName; };
      clap = rustPackages."registry+https://github.com/rust-lang/crates.io-index".clap."2.33.3" { inherit profileName; };
      derive_more = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".derive_more."0.99.9" { profileName = "__noProfile"; };
      ...
      rustc_ast = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast."705.0.0" { inherit profileName; };
      rustc_ast_pretty = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast_pretty."705.0.0" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."705.0.0" { inherit profileName; };
      rustc_errors = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_errors."705.0.0" { inherit profileName; };
      rustc_parse = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_parse."705.0.0" { inherit profileName; };
      rustc_session = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_session."705.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."705.0.0" { inherit profileName; };
    };
  });
  ...
  "unknown".rls."1.41.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if rootFeatures' ? "rls/clippy" || rootFeatures' ? "rls/clippy_lints" then "clippy_lints" else null } = rustPackages."unknown".clippy_lints."0.1.52" { inherit profileName; };
      ...
      racer = rustPackages."registry+https://github.com/rust-lang/crates.io-index".racer."2.1.44" { inherit profileName; };
      rand = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rand."0.7.3" { inherit profileName; };
      rayon = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rayon."1.3.1" { inherit profileName; };
      regex = rustPackages."registry+https://github.com/rust-lang/crates.io-index".regex."1.4.3" { inherit profileName; };
      ...
      rustfmt_nightly = rustPackages."unknown".rustfmt-nightly."1.4.36" { inherit profileName; };
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.118" { inherit profileName; };
      serde_derive = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_derive."1.0.118" { profileName = "__noProfile"; };
      serde_ignored = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_ignored."0.1.2" { inherit profileName; };
      serde_json = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.59" { inherit profileName; };
  ...
  "unknown".rls-rustc."0.6.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rls/clippy" || rootFeatures' ? "rls-rustc/clippy" || rootFeatures' ? "rls-rustc/clippy_lints" then "clippy_lints" else null } = rustPackages."unknown".clippy_lints."0.1.52" { inherit profileName; };
      env_logger = rustPackages."registry+https://github.com/rust-lang/crates.io-index".env_logger."0.7.1" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-rustc/ipc" || rootFeatures' ? "rls-rustc/serde" then "serde" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.118" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_arena."705.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_arena";
    version = "705.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "93575affa286089b92c8208aea4e60fe9fdd251a619a09b566d6e4e2cc123212"; };
    dependencies = {
      smallvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".smallvec."1.6.1" { inherit profileName; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast."705.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_ast";
    version = "705.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "4c700f2d3b25aa8d6446dd2936048737b08b2d547bd86e2a70afa9fee4e9c522"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.2.1" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."705.0.0" { inherit profileName; };
      rustc_index = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_index."705.0.0" { inherit profileName; };
      rustc_lexer = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_lexer."705.0.0" { inherit profileName; };
      rustc_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."705.0.0" { profileName = "__noProfile"; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_serialize."705.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."705.0.0" { inherit profileName; };
      smallvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".smallvec."1.6.1" { inherit profileName; };
      tracing = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.25" { inherit profileName; };
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast_passes."705.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_ast_passes";
    version = "705.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "8e01f63e5259ee397bbe2e395d34a2e6b6b24f10c184d30fbbee1dcd7117f4f3"; };
    dependencies = {
      itertools = rustPackages."registry+https://github.com/rust-lang/crates.io-index".itertools."0.9.0" { inherit profileName; };
      rustc_ast = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast."705.0.0" { inherit profileName; };
      rustc_ast_pretty = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast_pretty."705.0.0" { inherit profileName; };
      rustc_attr = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_attr."705.0.0" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."705.0.0" { inherit profileName; };
      rustc_errors = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_errors."705.0.0" { inherit profileName; };
      rustc_feature = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_feature."705.0.0" { inherit profileName; };
      rustc_parse = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_parse."705.0.0" { inherit profileName; };
      rustc_session = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_session."705.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."705.0.0" { inherit profileName; };
      tracing = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.25" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast_pretty."705.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_ast_pretty";
    version = "705.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "99d644c69c55deb24257cb0cb5261265fe5134f6f545e9062e1c18b07e422c68"; };
    dependencies = {
      rustc_ast = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast."705.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."705.0.0" { inherit profileName; };
      tracing = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.25" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_attr."705.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_attr";
    version = "705.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "797fc68816d5396870f04e03d35164f5275d2502403239d4caec7ce063683f41"; };
    dependencies = {
      rustc_ast = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast."705.0.0" { inherit profileName; };
      rustc_ast_pretty = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast_pretty."705.0.0" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."705.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."705.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_data_structures";
    version = "705.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "5d840c4e6198b57982a54543ae604d634c7ceb7107f0c75970b88ebaff077ac5"; };
    dependencies = {
      arrayvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".arrayvec."0.5.1" { inherit profileName; };
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.2.1" { inherit profileName; };
      cfg_if = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."0.1.10" { inherit profileName; };
      ...
      parking_lot = rustPackages."registry+https://github.com/rust-lang/crates.io-index".parking_lot."0.11.0" { inherit profileName; };
      rustc_graphviz = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_graphviz."705.0.0" { inherit profileName; };
      rustc_index = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_index."705.0.0" { inherit profileName; };
      rustc_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."705.0.0" { profileName = "__noProfile"; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_serialize."705.0.0" { inherit profileName; };
      rustc_hash = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-hash."1.1.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_errors."705.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_errors";
    version = "705.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "2f2f99bdc828ad417636d9016611dc9047b641fadcb7f533b8b0e9616d81f90b"; };
    dependencies = {
      ...
      atty = rustPackages."registry+https://github.com/rust-lang/crates.io-index".atty."0.2.14" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."705.0.0" { inherit profileName; };
      rustc_lint_defs = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_lint_defs."705.0.0" { inherit profileName; };
      rustc_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."705.0.0" { profileName = "__noProfile"; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_serialize."705.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."705.0.0" { inherit profileName; };
      termcolor = rustPackages."registry+https://github.com/rust-lang/crates.io-index".termcolor."1.1.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_expand."705.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_expand";
    version = "705.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "27008b4c7ded287bf5cb20b84d6d5a6566329140f2e2bc8f6e68b37a34898595"; };
    dependencies = {
      rustc_ast = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast."705.0.0" { inherit profileName; };
      rustc_ast_passes = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast_passes."705.0.0" { inherit profileName; };
      rustc_ast_pretty = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast_pretty."705.0.0" { inherit profileName; };
      rustc_attr = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_attr."705.0.0" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."705.0.0" { inherit profileName; };
      rustc_errors = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_errors."705.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_feature."705.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_feature";
    version = "705.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "6bb47b53670f1263ed1389dda932d5b5a6daf98579c1f076c2ee7d7f22709b7c"; };
    dependencies = {
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."705.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."705.0.0" { inherit profileName; };
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_fs_util."705.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_fs_util";
    version = "705.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "cdaddc4bae5ffab17037553e172f5014686db600050429aaa60aec14fe780e84"; };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_graphviz."705.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_graphviz";
    version = "705.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "3d73c72543311e88786f7380a3bfd946395579c1a0c0441a879a97fcdea79130"; };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_index."705.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_index";
    version = "705.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "bba8d74ed4bad44a5b4264cf2a51ad0bd458ed56caa5bb090e989b8002ec6327"; };
    dependencies = {
      arrayvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".arrayvec."0.5.1" { inherit profileName; };
      rustc_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."705.0.0" { profileName = "__noProfile"; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_serialize."705.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_lexer."705.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_lexer";
    version = "705.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "3a030d00510966cd31e13dca5e6c1bd40d303a932c54eca40e854188bca8c49e"; };
    dependencies = {
      unicode_xid = rustPackages."registry+https://github.com/rust-lang/crates.io-index".unicode-xid."0.2.1" { inherit profileName; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_lint_defs."705.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_lint_defs";
    version = "705.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "bdff95da1b5d979183ef5c285817ba6cc67a1ac11296ef1e87b1b5bbaf57213c"; };
    dependencies = {
      rustc_ast = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast."705.0.0" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."705.0.0" { inherit profileName; };
      rustc_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."705.0.0" { profileName = "__noProfile"; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_serialize."705.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."705.0.0" { inherit profileName; };
      rustc_target = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_target."705.0.0" { inherit profileName; };
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.25" { inherit profileName; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."705.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_macros";
    version = "705.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "fe3ed7401bf6f5a256d58cd0e1c1e2e77eec25e60a0d7ad75313962edcb4e396"; };
    dependencies = {
      proc_macro2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.19" { inherit profileName; };
      quote = rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.7" { inherit profileName; };
      syn = rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."1.0.38" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_parse."705.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_parse";
    version = "705.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "609a624baffa3f99847d57d30c96ee6732ce0912f8df4be239b6fd91533910d6"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.2.1" { inherit profileName; };
      rustc_ast = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast."705.0.0" { inherit profileName; };
      rustc_ast_pretty = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast_pretty."705.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_serialize."705.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_serialize";
    version = "705.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "bc232e2a351d8131c8f1386ce372ee22ef7b1b0b897bbf817a8ce4792029a564"; };
    dependencies = {
      indexmap = rustPackages."registry+https://github.com/rust-lang/crates.io-index".indexmap."1.6.0" { inherit profileName; };
      smallvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".smallvec."1.6.1" { inherit profileName; };
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_session."705.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_session";
    version = "705.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "18acf94c820cd0c64ee1cbd811fd1f4d5ba18987c457c88771359b90cb1a12f5"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.2.1" { inherit profileName; };
      getopts = rustPackages."registry+https://github.com/rust-lang/crates.io-index".getopts."0.2.21" { inherit profileName; };
      num_cpus = rustPackages."registry+https://github.com/rust-lang/crates.io-index".num_cpus."1.13.0" { inherit profileName; };
      ...
      rustc_errors = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_errors."705.0.0" { inherit profileName; };
      rustc_feature = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_feature."705.0.0" { inherit profileName; };
      rustc_fs_util = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_fs_util."705.0.0" { inherit profileName; };
      rustc_lint_defs = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_lint_defs."705.0.0" { inherit profileName; };
      rustc_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."705.0.0" { profileName = "__noProfile"; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_serialize."705.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."705.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."705.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_span";
    version = "705.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "d3479f453a38b6a5572938d035fc2b3cb6ec379c57f598b8682b512eb90c7858"; };
    dependencies = {
      cfg_if = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."0.1.10" { inherit profileName; };
      md5 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".md-5."0.9.1" { inherit profileName; };
      rustc_arena = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_arena."705.0.0" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."705.0.0" { inherit profileName; };
      rustc_index = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_index."705.0.0" { inherit profileName; };
      rustc_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."705.0.0" { profileName = "__noProfile"; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_serialize."705.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_target."705.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_target";
    version = "705.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "78cacaf829778cf07bb97a9f4604896789de12392175f3743e74a30ed370f1c1"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.2.1" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."705.0.0" { inherit profileName; };
      rustc_index = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_index."705.0.0" { inherit profileName; };
  ...
  "unknown".rustc-workspace-hack."1.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.118" { inherit profileName; };
      serde_json = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.59" { inherit profileName; };
      smallvec_0_6 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".smallvec."0.6.14" { inherit profileName; };
      smallvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".smallvec."1.6.1" { inherit profileName; };
      syn = rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."1.0.38" { inherit profileName; };
      url = rustPackages."registry+https://github.com/rust-lang/crates.io-index".url."2.1.1" { inherit profileName; };
      ${ if hostPlatform.isWindows then "winapi" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".winapi."0.3.9" { inherit profileName; };
  ...
  "unknown".rustfmt-nightly."1.4.36" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."705.0.0" { inherit profileName; };
      rustc_errors = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_errors."705.0.0" { inherit profileName; };
      rustc_expand = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_expand."705.0.0" { inherit profileName; };
      rustc_parse = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_parse."705.0.0" { inherit profileName; };
      rustc_session = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_session."705.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."705.0.0" { inherit profileName; };
      rustc_workspace_hack = rustPackages."unknown".rustc-workspace-hack."1.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".socket2."0.3.16" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if hostPlatform.isUnix || hostPlatform.parsed.kernel.name == "redox" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.88" { inherit profileName; };
      ${ if hostPlatform.parsed.kernel.name == "redox" then "syscall" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".redox_syscall."0.1.57" { inherit profileName; };
      ${ if hostPlatform.isWindows then "winapi" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".winapi."0.3.9" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tokio-macros."0.2.6" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "syn" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."1.0.38" { inherit profileName; };
    };
  });
