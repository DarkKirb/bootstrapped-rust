...
in
{
  ...
  workspace = {
    ...
    clippy = rustPackages.unknown.clippy."0.1.59";
    clippy_lints = rustPackages.unknown.clippy_lints."0.1.59";
    clippy_utils = rustPackages.unknown.clippy_utils."0.1.59";
  ...
  "registry+https://github.com/rust-lang/crates.io-index".addr2line."0.16.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "std/backtrace" || rootFeatures' ? "test/backtrace" then "compiler_builtins" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.67" { inherit profileName; };
  ...
  "unknown".alloc."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      compiler_builtins = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.67" { inherit profileName; };
  ...
  "unknown".cargo."0.60.0" = overridableMkRustCrate (profileName: rec {
    name = "cargo";
    version = "0.60.0";
    registry = "unknown";
    ...
    dependencies = {
      ...
      crates_io = rustPackages."unknown".crates-io."0.33.1" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".chalk-derive."0.75.0" = overridableMkRustCrate (profileName: rec {
    name = "chalk-derive";
    version = "0.75.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "d54e3b5f9e3425e6b119ff07568d8d006bfa5a8d6f78a9cbc3530b1e962e316c"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".chalk-engine."0.75.0" = overridableMkRustCrate (profileName: rec {
    name = "chalk-engine";
    version = "0.75.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "bdc891073396b167163db77123b0a3c00088edc00466cecc5531f33e3e989523"; };
    features = builtins.concatLists [
      [ "default" ]
    ];
    dependencies = {
      chalk_derive = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".chalk-derive."0.75.0" { profileName = "__noProfile"; };
      chalk_ir = rustPackages."registry+https://github.com/rust-lang/crates.io-index".chalk-ir."0.75.0" { inherit profileName; };
      chalk_solve = rustPackages."registry+https://github.com/rust-lang/crates.io-index".chalk-solve."0.75.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".chalk-ir."0.75.0" = overridableMkRustCrate (profileName: rec {
    name = "chalk-ir";
    version = "0.75.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "2b79e5a1d04b79311e90c69356a2c62027853906a7e33b3e070b93c055fc3e8a"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".chalk-solve."0.75.0" = overridableMkRustCrate (profileName: rec {
    name = "chalk-solve";
    version = "0.75.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "a5d2a1db6605aba70a58820bd80ac422b218913a510f1a40beef9efc5371ea1d"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "tracing-full" ]
      [ "tracing-subscriber" ]
  ...
  "unknown".clippy."0.1.59" = overridableMkRustCrate (profileName: rec {
    name = "clippy";
    version = "0.1.59";
    registry = "unknown";
    ...
    dependencies = {
      clippy_lints = rustPackages."unknown".clippy_lints."0.1.59" { inherit profileName; };
    ...
    devDependencies = {
      ...
      clippy_utils = rustPackages."unknown".clippy_utils."0.1.59" { inherit profileName; };
  ...
  "unknown".clippy_lints."0.1.59" = overridableMkRustCrate (profileName: rec {
    name = "clippy_lints";
    version = "0.1.59";
    registry = "unknown";
  ...
  "unknown".clippy_utils."0.1.59" = overridableMkRustCrate (profileName: rec {
    name = "clippy_utils";
    version = "0.1.59";
    registry = "unknown";
  ...
  "registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.67" = overridableMkRustCrate (profileName: rec {
    name = "compiler_builtins";
    version = "0.1.67";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "a68c69e9451f1df4b215c9588c621670c12286b53e60fb5ec4b59aaa1138d18e"; };
    features = builtins.concatLists [
  ...
  "unknown".crates-io."0.33.1" = overridableMkRustCrate (profileName: rec {
    name = "crates-io";
    version = "0.33.1";
    registry = "unknown";
  ...
  "registry+https://github.com/rust-lang/crates.io-index".dlmalloc."0.2.3" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      compiler_builtins = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.67" { inherit profileName; };
      ${ if hostPlatform.isUnix && !(hostPlatform.parsed.cpu.name == "wasm32") then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.108" { inherit profileName; };
      core = rustPackages."unknown".rustc-std-workspace-core."1.99.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".parity-tokio-ipc."0.9.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "futures" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures."0.3.12" { inherit profileName; };
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.108" { inherit profileName; };
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "log" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.14" { inherit profileName; };
  ...
  "unknown".rls."1.41.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      anyhow = rustPackages."registry+https://github.com/rust-lang/crates.io-index".anyhow."1.0.51" { inherit profileName; };
      cargo = rustPackages."unknown".cargo."0.60.0" { inherit profileName; };
      cargo_util = rustPackages."unknown".cargo-util."0.1.2" { inherit profileName; };
      cargo_metadata = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cargo_metadata."0.14.0" { inherit profileName; };
      ${ if rootFeatures' ? "rls/clippy" || rootFeatures' ? "rls/clippy_lints" then "clippy_lints" else null } = rustPackages."unknown".clippy_lints."0.1.59" { inherit profileName; };
  ...
  "unknown".rls-rustc."0.6.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rls/clippy" || rootFeatures' ? "rls-rustc/clippy" || rootFeatures' ? "rls-rustc/clippy_lints" then "clippy_lints" else null } = rustPackages."unknown".clippy_lints."0.1.59" { inherit profileName; };
      env_logger = rustPackages."registry+https://github.com/rust-lang/crates.io-index".env_logger."0.7.1" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_lint_defs."722.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.29" { inherit profileName; };
    };
  });
  ...
  "unknown".rustc_codegen_ssa."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      tempfile = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tempfile."3.2.0" { inherit profileName; };
      thorin = rustPackages."registry+https://github.com/rust-lang/crates.io-index".thorin-dwp."0.1.1" { inherit profileName; };
      tracing = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.29" { inherit profileName; };
    };
  });
  ...
  "unknown".rustc_traits."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      chalk_engine = rustPackages."registry+https://github.com/rust-lang/crates.io-index".chalk-engine."0.75.0" { inherit profileName; };
      chalk_ir = rustPackages."registry+https://github.com/rust-lang/crates.io-index".chalk-ir."0.75.0" { inherit profileName; };
      chalk_solve = rustPackages."registry+https://github.com/rust-lang/crates.io-index".chalk-solve."0.75.0" { inherit profileName; };
      rustc_ast = rustPackages."unknown".rustc_ast."0.0.0" { inherit profileName; };
      rustc_attr = rustPackages."unknown".rustc_attr."0.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".thorin-dwp."0.1.1" = overridableMkRustCrate (profileName: rec {
    name = "thorin-dwp";
    version = "0.1.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "039d1fc0bfdb73910c2702893515580e38c192f47a987bc98ddd38a36f2d953a"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tikv-jemalloc-sys."0.4.1+5.2.1-patched" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rustc-main/jemalloc" || rootFeatures' ? "rustc-main/tikv-jemalloc-sys" || rootFeatures' ? "rustc-main/tikv-jemallocator" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.108" { inherit profileName; };
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tikv-jemallocator."0.4.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rustc-main/jemalloc" || rootFeatures' ? "rustc-main/tikv-jemallocator" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.108" { inherit profileName; };
