...
in
{
  ...
  workspace = {
    ...
    clippy = rustPackages.unknown.clippy."0.1.53";
    clippy_lints = rustPackages.unknown.clippy_lints."0.1.53";
    clippy_utils = rustPackages.unknown.clippy_utils."0.1.53";
    ...
    cargo = rustPackages.unknown.cargo."0.54.0";
  ...
  "registry+https://github.com/rust-lang/crates.io-index".addr2line."0.14.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "std/backtrace" || rootFeatures' ? "test/backtrace" then "compiler_builtins" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.39" { inherit profileName; };
  ...
  "unknown".alloc."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      compiler_builtins = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.39" { inherit profileName; };
  ...
  "unknown".cargo."0.54.0" = overridableMkRustCrate (profileName: rec {
    name = "cargo";
    version = "0.54.0";
    registry = "unknown";
  ...
  "unknown".clippy."0.1.53" = overridableMkRustCrate (profileName: rec {
    name = "clippy";
    version = "0.1.53";
    registry = "unknown";
    ...
    features = builtins.concatLists [
      ...
      (lib.optional (rootFeatures' ? "clippy/internal-lints") "internal-lints")
      (lib.optional (rootFeatures' ? "clippy/integration" || rootFeatures' ? "clippy/tempfile") "tempfile")
    ];
    dependencies = {
      clippy_lints = rustPackages."unknown".clippy_lints."0.1.53" { inherit profileName; };
  ...
  "unknown".clippy_lints."0.1.53" = overridableMkRustCrate (profileName: rec {
    name = "clippy_lints";
    version = "0.1.53";
    registry = "unknown";
    ...
    features = builtins.concatLists [
      ...
      (lib.optional (rootFeatures' ? "clippy/internal-lints" || rootFeatures' ? "clippy_lints/internal-lints") "internal-lints")
    ];
    dependencies = {
      cargo_metadata = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cargo_metadata."0.12.0" { inherit profileName; };
      clippy_utils = rustPackages."unknown".clippy_utils."0.1.53" { inherit profileName; };
  ...
  "unknown".clippy_utils."0.1.53" = overridableMkRustCrate (profileName: rec {
    name = "clippy_utils";
    version = "0.1.53";
    registry = "unknown";
    src = fetchCrateLocal (workspaceSrc + "/src/tools/clippy/clippy_utils");
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "clippy/internal-lints" || rootFeatures' ? "clippy_lints/internal-lints" || rootFeatures' ? "clippy_utils/internal-lints") "internal-lints")
    ];
    dependencies = {
      if_chain = rustPackages."registry+https://github.com/rust-lang/crates.io-index".if_chain."1.0.0" { inherit profileName; };
      itertools = rustPackages."registry+https://github.com/rust-lang/crates.io-index".itertools."0.9.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.39" = overridableMkRustCrate (profileName: rec {
    name = "compiler_builtins";
    version = "0.1.39";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "3748f82c7d366a0b4950257d19db685d4958d2fa27c6d164a3f069fec42b748b"; };
    features = builtins.concatLists [
  ...
  "registry+https://github.com/rust-lang/crates.io-index".curl."0.4.34" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      socket2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".socket2."0.3.16" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".measureme."9.1.0" = overridableMkRustCrate (profileName: rec {
    name = "measureme";
    version = "9.1.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "4a98e07fe802486895addb2b5467f33f205e82c426bfaf350f5d8109b137767c"; };
    dependencies = {
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.11" { inherit profileName; };
      ${ if hostPlatform.parsed.cpu.name == "x86_64" && hostPlatform.parsed.kernel.name == "linux" then "memmap" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".memmap."0.7.0" { inherit profileName; };
      parking_lot = rustPackages."registry+https://github.com/rust-lang/crates.io-index".parking_lot."0.11.1" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".minifier."0.0.39" = overridableMkRustCrate (profileName: rec {
    name = "minifier";
    version = "0.0.39";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "6cdf618de5c9c98d4a7b2e0d1f1e44f82a19196cfd94040bb203621c25d28d98"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".openssl-src."111.12.0+1.1.1h" = overridableMkRustCrate (profileName: rec {
    name = "openssl-src";
    version = "111.12.0+1.1.1h";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "858a4132194f8570a7ee9eb8629e85b23cbc4565f2d4a162e87556e5956abf61"; };
    features = builtins.concatLists [
  ...
  "registry+https://github.com/rust-lang/crates.io-index".openssl-sys."0.9.58" = overridableMkRustCrate (profileName: rec {
    ...
    buildDependencies = {
      autocfg = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".autocfg."1.0.0" { profileName = "__noProfile"; };
      cc = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.60" { profileName = "__noProfile"; };
      ${ if rootFeatures' ? "cargo/vendored-openssl" then "openssl_src" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".openssl-src."111.12.0+1.1.1h" { profileName = "__noProfile"; };
      pkg_config = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".pkg-config."0.3.18" { profileName = "__noProfile"; };
      ${ if hostPlatform.parsed.abi.name == "msvc" then "vcpkg" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".vcpkg."0.2.10" { profileName = "__noProfile"; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".racer."2.1.46" = overridableMkRustCrate (profileName: rec {
    name = "racer";
    version = "2.1.46";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "e7cbda48a9124ed2e83766d2c15e3725710d344abca35fad8cf52341a55883b1"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.2.1" { inherit profileName; };
      clap = rustPackages."registry+https://github.com/rust-lang/crates.io-index".clap."2.33.3" { inherit profileName; };
      derive_more = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".derive_more."0.99.9" { profileName = "__noProfile"; };
      ...
      rustc_ast = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast."718.0.0" { inherit profileName; };
      rustc_ast_pretty = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast_pretty."718.0.0" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."718.0.0" { inherit profileName; };
      rustc_errors = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_errors."718.0.0" { inherit profileName; };
      rustc_parse = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_parse."718.0.0" { inherit profileName; };
      rustc_session = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_session."718.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."718.0.0" { inherit profileName; };
    };
  });
  ...
  "unknown".rls."1.41.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      anyhow = rustPackages."registry+https://github.com/rust-lang/crates.io-index".anyhow."1.0.34" { inherit profileName; };
      cargo = rustPackages."unknown".cargo."0.54.0" { inherit profileName; };
      cargo_util = rustPackages."unknown".cargo-util."0.1.0" { inherit profileName; };
      cargo_metadata = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cargo_metadata."0.8.2" { inherit profileName; };
      ${ if rootFeatures' ? "rls/clippy" || rootFeatures' ? "rls/clippy_lints" then "clippy_lints" else null } = rustPackages."unknown".clippy_lints."0.1.53" { inherit profileName; };
      ...
      racer = rustPackages."registry+https://github.com/rust-lang/crates.io-index".racer."2.1.46" { inherit profileName; };
      rand = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rand."0.7.3" { inherit profileName; };
      rayon = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rayon."1.3.1" { inherit profileName; };
      regex = rustPackages."registry+https://github.com/rust-lang/crates.io-index".regex."1.4.3" { inherit profileName; };
  ...
  "unknown".rls-rustc."0.6.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rls/clippy" || rootFeatures' ? "rls-rustc/clippy" || rootFeatures' ? "rls-rustc/clippy_lints" then "clippy_lints" else null } = rustPackages."unknown".clippy_lints."0.1.53" { inherit profileName; };
      env_logger = rustPackages."registry+https://github.com/rust-lang/crates.io-index".env_logger."0.7.1" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_arena."718.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_arena";
    version = "718.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "526610f47139efa440178239553b59ea805ff57a532b4e295c71d2a9b18fd676"; };
    dependencies = {
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."718.0.0" { inherit profileName; };
      smallvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".smallvec."1.6.1" { inherit profileName; };
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast."718.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_ast";
    version = "718.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "cf6a9dda0804a7243b0282e3b75a8cf4654c7a61f033e587751941e1fe39391b"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.2.1" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."718.0.0" { inherit profileName; };
      rustc_index = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_index."718.0.0" { inherit profileName; };
      rustc_lexer = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_lexer."718.0.0" { inherit profileName; };
      rustc_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."718.0.0" { profileName = "__noProfile"; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_serialize."718.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."718.0.0" { inherit profileName; };
      smallvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".smallvec."1.6.1" { inherit profileName; };
      tracing = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.25" { inherit profileName; };
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast_pretty."718.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_ast_pretty";
    version = "718.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "82f5019be8b41a58664169fd2f4b1a37fe82705681db394b76419e4e87d40ab1"; };
    dependencies = {
      rustc_ast = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast."718.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."718.0.0" { inherit profileName; };
      tracing = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.25" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."718.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_data_structures";
    version = "718.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "a701717fb14549331085756b9741ae3b4bf35808489f1887d72c1d0e0fe52b77"; };
    dependencies = {
      ...
      libc = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.93" { inherit profileName; };
      measureme = rustPackages."registry+https://github.com/rust-lang/crates.io-index".measureme."9.1.0" { inherit profileName; };
      ...
      parking_lot = rustPackages."registry+https://github.com/rust-lang/crates.io-index".parking_lot."0.11.1" { inherit profileName; };
      rustc_graphviz = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_graphviz."718.0.0" { inherit profileName; };
      rustc_index = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_index."718.0.0" { inherit profileName; };
      rustc_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."718.0.0" { profileName = "__noProfile"; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_serialize."718.0.0" { inherit profileName; };
      rustc_hash = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-hash."1.1.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_errors."718.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_errors";
    version = "718.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "e3182ce85e8bfc96443475547f2f5aa2b5e67655d9b88721795f36f0ba9e265a"; };
    dependencies = {
      ...
      atty = rustPackages."registry+https://github.com/rust-lang/crates.io-index".atty."0.2.14" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."718.0.0" { inherit profileName; };
      rustc_lint_defs = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_lint_defs."718.0.0" { inherit profileName; };
      rustc_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."718.0.0" { profileName = "__noProfile"; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_serialize."718.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."718.0.0" { inherit profileName; };
      termcolor = rustPackages."registry+https://github.com/rust-lang/crates.io-index".termcolor."1.1.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_feature."718.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_feature";
    version = "718.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "eed033b93270126ef60963c3ebbd0e026bf53b985172b6366c7b0e7881c9d507"; };
    dependencies = {
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."718.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."718.0.0" { inherit profileName; };
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_fs_util."718.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_fs_util";
    version = "718.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "28ee6531986a205101e09fd143d7bf31897388f33b1814d4bcc45fd62211dca6"; };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_graphviz."718.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_graphviz";
    version = "718.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "3398fddc0e23d2db89c036f8952ddf78cadc597f7059752116e69483e164a5b6"; };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_index."718.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_index";
    version = "718.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "dca4e27eb5b701f6bbd47d8fc9d242378fca3e4107a519a28415c2989c4a3bd3"; };
    dependencies = {
      arrayvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".arrayvec."0.7.0" { inherit profileName; };
      rustc_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."718.0.0" { profileName = "__noProfile"; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_serialize."718.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_lexer."718.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_lexer";
    version = "718.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "786bbfe9d4d5264294c1819dbf1497a2480b583d5eda1ca9ae22e12d6661f5df"; };
    dependencies = {
      unicode_xid = rustPackages."registry+https://github.com/rust-lang/crates.io-index".unicode-xid."0.2.1" { inherit profileName; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_lint_defs."718.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_lint_defs";
    version = "718.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "be2f045e2b999c154ec505d5fea69c994b742f3ebd2f552d11a6c81723921e47"; };
    dependencies = {
      rustc_ast = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast."718.0.0" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."718.0.0" { inherit profileName; };
      rustc_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."718.0.0" { profileName = "__noProfile"; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_serialize."718.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."718.0.0" { inherit profileName; };
      rustc_target = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_target."718.0.0" { inherit profileName; };
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tracing."0.1.25" { inherit profileName; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."718.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_macros";
    version = "718.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "27789cd26d6b9e2fdfa68a262a20664d79ca67d31a3886d40fb88ebf6935869c"; };
    dependencies = {
      proc_macro2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.24" { inherit profileName; };
      quote = rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.7" { inherit profileName; };
      syn = rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."1.0.65" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_parse."718.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_parse";
    version = "718.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "1dc331f4958350679679e619d63a891e8d5d34ef99087068c89aa9e657d52caa"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.2.1" { inherit profileName; };
      rustc_ast = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast."718.0.0" { inherit profileName; };
      rustc_ast_pretty = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_ast_pretty."718.0.0" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."718.0.0" { inherit profileName; };
      rustc_errors = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_errors."718.0.0" { inherit profileName; };
      rustc_feature = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_feature."718.0.0" { inherit profileName; };
      rustc_lexer = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_lexer."718.0.0" { inherit profileName; };
      rustc_session = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_session."718.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."718.0.0" { inherit profileName; };
      smallvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".smallvec."1.6.1" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_serialize."718.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_serialize";
    version = "718.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "e9a6824a462c4c1a379e911b0faf86d303a54bcf8673d4cc445195085966a4a4"; };
    dependencies = {
      indexmap = rustPackages."registry+https://github.com/rust-lang/crates.io-index".indexmap."1.6.0" { inherit profileName; };
      smallvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".smallvec."1.6.1" { inherit profileName; };
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_session."718.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_session";
    version = "718.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "a782a5f6ada0dbe089c6416ad0104f0b8a8bdb4bd26ea95e5fefaec67aed5e8a"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.2.1" { inherit profileName; };
      getopts = rustPackages."registry+https://github.com/rust-lang/crates.io-index".getopts."0.2.21" { inherit profileName; };
      num_cpus = rustPackages."registry+https://github.com/rust-lang/crates.io-index".num_cpus."1.13.0" { inherit profileName; };
      ...
      rustc_errors = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_errors."718.0.0" { inherit profileName; };
      rustc_feature = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_feature."718.0.0" { inherit profileName; };
      rustc_fs_util = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_fs_util."718.0.0" { inherit profileName; };
      rustc_lint_defs = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_lint_defs."718.0.0" { inherit profileName; };
      rustc_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."718.0.0" { profileName = "__noProfile"; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_serialize."718.0.0" { inherit profileName; };
      rustc_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."718.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_span."718.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_span";
    version = "718.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "a257546cb264b250c7abdb81239bb02f18a274a966211755a3ea89411b122214"; };
    dependencies = {
      cfg_if = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."0.1.10" { inherit profileName; };
      md5 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".md-5."0.9.1" { inherit profileName; };
      rustc_arena = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_arena."718.0.0" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."718.0.0" { inherit profileName; };
      rustc_index = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_index."718.0.0" { inherit profileName; };
      rustc_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."718.0.0" { profileName = "__noProfile"; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_serialize."718.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_target."718.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_target";
    version = "718.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b5a72dd689421bcb5750f3ed0dedf367076e714ef0ba56c02ed391b9a8582862"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.2.1" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."718.0.0" { inherit profileName; };
      rustc_index = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_index."718.0.0" { inherit profileName; };
  ...
  "unknown".rustdoc."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      arrayvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".arrayvec."0.7.0" { inherit profileName; };
      itertools = rustPackages."registry+https://github.com/rust-lang/crates.io-index".itertools."0.9.0" { inherit profileName; };
      minifier = rustPackages."registry+https://github.com/rust-lang/crates.io-index".minifier."0.0.39" { inherit profileName; };
      pulldown_cmark = rustPackages."registry+https://github.com/rust-lang/crates.io-index".pulldown-cmark."0.8.0" { inherit profileName; };
      regex = rustPackages."registry+https://github.com/rust-lang/crates.io-index".regex."1.4.3" { inherit profileName; };
      rayon = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-rayon."0.3.1" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".socket2."0.3.16" = overridableMkRustCrate (profileName: rec {
    name = "socket2";
    version = "0.3.16";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "7fd8b795c389288baa5f355489c65e71fd48a02104600d15c4cfbc561e9e429d"; };
    dependencies = {
      ...
      ${ if hostPlatform.isUnix || hostPlatform.parsed.kernel.name == "redox" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.93" { inherit profileName; };
      ${ if hostPlatform.parsed.kernel.name == "redox" then "syscall" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".redox_syscall."0.1.57" { inherit profileName; };
      ${ if hostPlatform.isWindows then "winapi" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".winapi."0.3.9" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tikv-jemalloc-sys."0.4.1+5.2.1-patched" = overridableMkRustCrate (profileName: rec {
    ...
    buildDependencies = {
      ${ if rootFeatures' ? "rustc-main/jemalloc" || rootFeatures' ? "rustc-main/tikv-jemalloc-sys" || rootFeatures' ? "rustc-main/tikv-jemallocator" then "cc" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.60" { profileName = "__noProfile"; };
