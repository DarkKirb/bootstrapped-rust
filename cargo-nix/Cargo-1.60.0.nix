...
in
{
  ...
  workspace = {
    ...
    clippy = rustPackages.unknown.clippy."0.1.60";
    clippy_lints = rustPackages.unknown.clippy_lints."0.1.60";
    clippy_utils = rustPackages.unknown.clippy_utils."0.1.60";
    ...
    cargo = rustPackages.unknown.cargo."0.61.0";
  ...
  "unknown".cargo."0.61.0" = overridableMkRustCrate (profileName: rec {
    name = "cargo";
    version = "0.61.0";
    registry = "unknown";
  ...
  "registry+https://github.com/rust-lang/crates.io-index".chalk-derive."0.76.0" = overridableMkRustCrate (profileName: rec {
    name = "chalk-derive";
    version = "0.76.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "58c24b8052ea1e3adbb6f9ab7ba5fcc18b9d12591c042de4c833f709ce81e0e0"; };
    dependencies = {
      proc_macro2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."1.0.30" { inherit profileName; };
      quote = rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."1.0.7" { inherit profileName; };
      syn = rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."1.0.80" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".chalk-engine."0.76.0" = overridableMkRustCrate (profileName: rec {
    name = "chalk-engine";
    version = "0.76.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "0eca186b6ea9af798312f4b568fd094c82e7946ac08be5dc5fea22decc6d2ed8"; };
    features = builtins.concatLists [
      [ "default" ]
    ];
    dependencies = {
      chalk_derive = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".chalk-derive."0.76.0" { profileName = "__noProfile"; };
      chalk_ir = rustPackages."registry+https://github.com/rust-lang/crates.io-index".chalk-ir."0.76.0" { inherit profileName; };
      chalk_solve = rustPackages."registry+https://github.com/rust-lang/crates.io-index".chalk-solve."0.76.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".chalk-ir."0.76.0" = overridableMkRustCrate (profileName: rec {
    name = "chalk-ir";
    version = "0.76.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "f3cad5c3f1edd4b4a2c9bda24ae558ceb4f88336f88f944c2e35d0bfeb13c818"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".chalk-solve."0.76.0" = overridableMkRustCrate (profileName: rec {
    name = "chalk-solve";
    version = "0.76.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "94533188d3452bc72cbd5618d166f45fc7646b674ad3fe9667d557bc25236dee"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "tracing-full" ]
      [ "tracing-subscriber" ]
  ...
  "unknown".clippy."0.1.60" = overridableMkRustCrate (profileName: rec {
    name = "clippy";
    version = "0.1.60";
    registry = "unknown";
    ...
    dependencies = {
      clippy_lints = rustPackages."unknown".clippy_lints."0.1.60" { inherit profileName; };
    ...
    devDependencies = {
      ...
      clippy_utils = rustPackages."unknown".clippy_utils."0.1.60" { inherit profileName; };
  ...
  "unknown".clippy_lints."0.1.60" = overridableMkRustCrate (profileName: rec {
    name = "clippy_lints";
    version = "0.1.60";
    registry = "unknown";
  ...
  "unknown".clippy_utils."0.1.60" = overridableMkRustCrate (profileName: rec {
    name = "clippy_utils";
    version = "0.1.60";
    registry = "unknown";
  ...
  "registry+https://github.com/rust-lang/crates.io-index".indexmap."1.8.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      rustc_rayon = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-rayon."0.3.2" { inherit profileName; };
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.125" { inherit profileName; };
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".minifier."0.0.42" = overridableMkRustCrate (profileName: rec {
    name = "minifier";
    version = "0.0.42";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "55a1388517eda8a68875243b650c26997e055a33d82571b5a0349129faef7d99"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".racer."2.2.0" = overridableMkRustCrate (profileName: rec {
    name = "racer";
    version = "2.2.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b0b4b5faaf07040474e8af74a9e19ff167d5d204df5db5c5c765edecfb900358"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.2.1" { inherit profileName; };
      clap = rustPackages."registry+https://github.com/rust-lang/crates.io-index".clap."2.34.0" { inherit profileName; };
      derive_more = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".derive_more."0.99.9" { profileName = "__noProfile"; };
  ...
  "unknown".rls."1.41.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      anyhow = rustPackages."registry+https://github.com/rust-lang/crates.io-index".anyhow."1.0.51" { inherit profileName; };
      cargo = rustPackages."unknown".cargo."0.61.0" { inherit profileName; };
      cargo_util = rustPackages."unknown".cargo-util."0.1.2" { inherit profileName; };
      cargo_metadata = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cargo_metadata."0.14.0" { inherit profileName; };
      ${ if rootFeatures' ? "rls/clippy" || rootFeatures' ? "rls/clippy_lints" then "clippy_lints" else null } = rustPackages."unknown".clippy_lints."0.1.60" { inherit profileName; };
      crossbeam_channel = rustPackages."registry+https://github.com/rust-lang/crates.io-index".crossbeam-channel."0.5.2" { inherit profileName; };
      env_logger = rustPackages."registry+https://github.com/rust-lang/crates.io-index".env_logger."0.9.0" { inherit profileName; };
      ...
      racer = rustPackages."registry+https://github.com/rust-lang/crates.io-index".racer."2.2.0" { inherit profileName; };
      rand = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rand."0.8.4" { inherit profileName; };
      rayon = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rayon."1.5.1" { inherit profileName; };
      regex = rustPackages."registry+https://github.com/rust-lang/crates.io-index".regex."1.5.4" { inherit profileName; };
  ...
  "unknown".rls-rustc."0.6.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rls/clippy" || rootFeatures' ? "rls-rustc/clippy" || rootFeatures' ? "rls-rustc/clippy_lints" then "clippy_lints" else null } = rustPackages."unknown".clippy_lints."0.1.60" { inherit profileName; };
      env_logger = rustPackages."registry+https://github.com/rust-lang/crates.io-index".env_logger."0.9.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-rayon."0.3.2" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      crossbeam_deque = rustPackages."registry+https://github.com/rust-lang/crates.io-index".crossbeam-deque."0.8.1" { inherit profileName; };
      either = rustPackages."registry+https://github.com/rust-lang/crates.io-index".either."1.6.0" { inherit profileName; };
      rayon_core = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-rayon-core."0.3.2" { inherit profileName; };
    };
  });
  ...
  "unknown".rustc_data_structures."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      parking_lot = rustPackages."registry+https://github.com/rust-lang/crates.io-index".parking_lot."0.11.2" { inherit profileName; };
      rustc_hash = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-hash."1.1.0" { inherit profileName; };
      rayon = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-rayon."0.3.2" { inherit profileName; };
      rayon_core = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-rayon-core."0.3.2" { inherit profileName; };
      rustc_graphviz = rustPackages."unknown".rustc_graphviz."0.0.0" { inherit profileName; };
      rustc_index = rustPackages."unknown".rustc_index."0.0.0" { inherit profileName; };
      rustc_macros = buildRustPackages."unknown".rustc_macros."0.1.0" { profileName = "__noProfile"; };
  ...
  "unknown".rustc_interface."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      libloading = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libloading."0.7.1" { inherit profileName; };
      rayon = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-rayon."0.3.2" { inherit profileName; };
      rustc_rayon_core = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-rayon-core."0.3.2" { inherit profileName; };
      rustc_ast = rustPackages."unknown".rustc_ast."0.0.0" { inherit profileName; };
  ...
  "unknown".rustc_traits."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      chalk_engine = rustPackages."registry+https://github.com/rust-lang/crates.io-index".chalk-engine."0.76.0" { inherit profileName; };
      chalk_ir = rustPackages."registry+https://github.com/rust-lang/crates.io-index".chalk-ir."0.76.0" { inherit profileName; };
      chalk_solve = rustPackages."registry+https://github.com/rust-lang/crates.io-index".chalk-solve."0.76.0" { inherit profileName; };
      rustc_ast = rustPackages."unknown".rustc_ast."0.0.0" { inherit profileName; };
      rustc_attr = rustPackages."unknown".rustc_attr."0.0.0" { inherit profileName; };
  ...
  "unknown".rustdoc."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      atty = rustPackages."registry+https://github.com/rust-lang/crates.io-index".atty."0.2.14" { inherit profileName; };
      itertools = rustPackages."registry+https://github.com/rust-lang/crates.io-index".itertools."0.10.1" { inherit profileName; };
      minifier = rustPackages."registry+https://github.com/rust-lang/crates.io-index".minifier."0.0.42" { inherit profileName; };
      pulldown_cmark = rustPackages."registry+https://github.com/rust-lang/crates.io-index".pulldown-cmark."0.9.1" { inherit profileName; };
      rayon = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rayon."1.5.1" { inherit profileName; };
      regex = rustPackages."registry+https://github.com/rust-lang/crates.io-index".regex."1.5.4" { inherit profileName; };
