...
in
{
  ...
  workspace = {
    ...
    rustc_ast_borrowck = rustPackages.unknown.rustc_ast_borrowck."0.0.0";
    ...
    cargo = rustPackages.unknown.cargo."0.40.0";
    crates-io = rustPackages.unknown.crates-io."0.28.0";
    ...
    rls = rustPackages.unknown.rls."1.39.0";
    rls-ipc = rustPackages.unknown.rls-ipc."0.1.0";
    rls-rustc = rustPackages.unknown.rls-rustc."0.6.0";
    rustfmt-nightly = rustPackages.unknown.rustfmt-nightly."1.4.8";
  ...
  "registry+https://github.com/rust-lang/crates.io-index".ammonia."2.1.2" = overridableMkRustCrate (profileName: rec {
    name = "ammonia";
    version = "2.1.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "384d704f242a0a9faf793fff775a0be6ab9aa27edabffa097331d73779142520"; };
    dependencies = {
      html5ever = rustPackages."registry+https://github.com/rust-lang/crates.io-index".html5ever."0.23.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".backtrace."0.3.37" = overridableMkRustCrate (profileName: rec {
    name = "backtrace";
    version = "0.3.37";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "5180c5a20655b14a819b652fd2378fa5f1697b6c9ddad3e695c2f9cedf6df4e2"; };
    features = builtins.concatLists [
      [ "backtrace-sys" ]
      [ "compiler_builtins" ]
      [ "core" ]
    ...
    dependencies = {
      backtrace_sys = rustPackages."registry+https://github.com/rust-lang/crates.io-index".backtrace-sys."0.1.30" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".backtrace-sys."0.1.30" = overridableMkRustCrate (profileName: rec {
    name = "backtrace-sys";
    version = "0.1.30";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "5b3a000b9c543553af61bc01cbfc403b04b5caa9e421033866f2e98061eb3e61"; };
    features = builtins.concatLists [
      [ "compiler_builtins" ]
      [ "core" ]
      [ "rustc-dep-of-std" ]
  ...
  "unknown".cargo."0.40.0" = overridableMkRustCrate (profileName: rec {
    name = "cargo";
    version = "0.40.0";
    registry = "unknown";
    ...
    dependencies = {
      ...
      crates_io = rustPackages."unknown".crates-io."0.28.0" { inherit profileName; };
      ...
      home = rustPackages."registry+https://github.com/rust-lang/crates.io-index".home."0.5.0" { inherit profileName; };
  ...
  "unknown".cargo-test-support."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      cargo = rustPackages."unknown".cargo."0.40.0" { inherit profileName; };
      cargo_test_macro = buildRustPackages."unknown".cargo-test-macro."0.1.0" { profileName = "__noProfile"; };
      filetime = rustPackages."registry+https://github.com/rust-lang/crates.io-index".filetime."0.2.4" { inherit profileName; };
      flate2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".flate2."1.0.6" { inherit profileName; };
      git2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".git2."0.10.0" { inherit profileName; };
  ...
  "unknown".clippy_lints."0.0.212" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      lazy_static = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lazy_static."1.3.0" { inherit profileName; };
      matches = rustPackages."registry+https://github.com/rust-lang/crates.io-index".matches."0.1.8" { inherit profileName; };
      pulldown_cmark = rustPackages."registry+https://github.com/rust-lang/crates.io-index".pulldown-cmark."0.6.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.18" = overridableMkRustCrate (profileName: rec {
    ...
    buildDependencies = {
      ${ if rootFeatures' ? "alloc/compiler-builtins-c" || rootFeatures' ? "std/compiler-builtins-c" || rootFeatures' ? "test/compiler-builtins-c" then "cc" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.35" { profileName = "__noProfile"; };
    };
  });
  ...
  "unknown".crates-io."0.28.0" = overridableMkRustCrate (profileName: rec {
    name = "crates-io";
    version = "0.28.0";
    registry = "unknown";
  ...
  "registry+https://github.com/rust-lang/crates.io-index".dlmalloc."0.1.3" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      compiler_builtins = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.18" { inherit profileName; };
      ${ if hostPlatform.isUnix && !(hostPlatform.parsed.cpu.name == "wasm32") then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.62" { inherit profileName; };
      core = rustPackages."unknown".rustc-std-workspace-core."1.99.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".encoding_rs."0.8.17" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "cfg_if" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."0.1.8" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".error-chain."0.12.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      backtrace = rustPackages."registry+https://github.com/rust-lang/crates.io-index".backtrace."0.3.37" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".futures-cpupool."0.1.8" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "num_cpus" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".num_cpus."1.8.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".getrandom."0.1.12" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      cfg_if = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."0.1.8" { inherit profileName; };
      ${ if hostPlatform.isUnix || hostPlatform.parsed.kernel.name == "redox" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.62" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".h2."0.1.25" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "futures" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures."0.1.28" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "http" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".http."0.1.16" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "tokio_io" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio-io."0.1.11" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".home."0.5.0" = overridableMkRustCrate (profileName: rec {
    name = "home";
    version = "0.5.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "c07c315e106bd6f83f026a20ddaeef2706782e490db1dcdd37caad38a0e895b3"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".html5ever."0.23.0" = overridableMkRustCrate (profileName: rec {
    name = "html5ever";
    version = "0.23.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "5ce65ac8028cf5a287a7dbf6c4e0a6cf2dcf022ed5b167a81bae66ebf599a8b7"; };
    dependencies = {
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.8" { inherit profileName; };
      mac = rustPackages."registry+https://github.com/rust-lang/crates.io-index".mac."0.1.1" { inherit profileName; };
      markup5ever = rustPackages."registry+https://github.com/rust-lang/crates.io-index".markup5ever."0.8.1" { inherit profileName; };
    };
    buildDependencies = {
      ...
      quote = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."0.6.12" { profileName = "__noProfile"; };
      syn = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."0.15.35" { profileName = "__noProfile"; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".hyper."0.12.31" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "iovec" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".iovec."0.1.2" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "itoa" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".itoa."0.4.4" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "log" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.8" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "time" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".time."0.1.40" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "tokio" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio."0.1.14" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "tokio_buf" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio-buf."0.1.1" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "tokio_executor" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio-executor."0.1.6" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "tokio_io" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio-io."0.1.11" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "tokio_reactor" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio-reactor."0.1.8" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "tokio_threadpool" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio-threadpool."0.1.10" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "tokio_timer" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tokio-timer."0.2.8" { inherit profileName; };
  ...
  "unknown".installer."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      num_cpus = rustPackages."registry+https://github.com/rust-lang/crates.io-index".num_cpus."1.8.0" { inherit profileName; };
      rayon = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rayon."1.1.0" { inherit profileName; };
      remove_dir_all = rustPackages."registry+https://github.com/rust-lang/crates.io-index".remove_dir_all."0.5.2" { inherit profileName; };
      tar = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tar."0.4.20" { inherit profileName; };
      walkdir = rustPackages."registry+https://github.com/rust-lang/crates.io-index".walkdir."2.2.7" { inherit profileName; };
      ${ if hostPlatform.isWindows then "winapi" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".winapi."0.3.6" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".jemalloc-sys."0.3.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rustc-main/jemalloc" || rootFeatures' ? "rustc-main/jemalloc-sys" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.62" { inherit profileName; };
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".jsonrpc-client-transports."13.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      jsonrpc_core = rustPackages."registry+https://github.com/rust-lang/crates.io-index".jsonrpc-core."13.1.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".jsonrpc-core."13.1.0" = overridableMkRustCrate (profileName: rec {
    name = "jsonrpc-core";
    version = "13.1.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "dd42951eb35079520ee29b7efbac654d85821b397ef88c8151600ef7e2d00217"; };
    dependencies = {
      futures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures."0.1.28" { inherit profileName; };
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.8" { inherit profileName; };
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.99" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".jsonrpc-ipc-server."13.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" then "jsonrpc_core" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".jsonrpc-core."13.1.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".jsonrpc-server-utils."13.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "jsonrpc_core" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".jsonrpc-core."13.1.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".libflate."0.1.25" = overridableMkRustCrate (profileName: rec {
    name = "libflate";
    version = "0.1.25";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "90c6f86f4b0caa347206f916f8b687b51d77c6ef8ff18d52dd007491fd580529"; };
    dependencies = {
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "adler32" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".adler32."1.0.3" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "byteorder" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".byteorder."1.3.2" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "crc32fast" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".crc32fast."1.1.2" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "rle_decode_fast" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rle-decode-fast."1.0.1" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "take_mut" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".take_mut."0.2.2" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".markup5ever."0.8.1" = overridableMkRustCrate (profileName: rec {
    name = "markup5ever";
    version = "0.8.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "f1af46a727284117e09780d05038b1ce6fc9c76cc6df183c3dae5a8955a25e21"; };
    dependencies = {
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.8" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".mdbook."0.3.1" = overridableMkRustCrate (profileName: rec {
    name = "mdbook";
    version = "0.3.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "949bb2acb2cff9fa5c375cf9c43e70b3dba0a974d9fe01c31285d7a84d2a0fa2"; };
    features = builtins.concatLists [
      [ "ammonia" ]
      [ "elasticlunr-rs" ]
      [ "search" ]
    ...
    dependencies = {
      ammonia = rustPackages."registry+https://github.com/rust-lang/crates.io-index".ammonia."2.1.2" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".mdbook-linkcheck."0.3.0" = overridableMkRustCrate (profileName: rec {
    name = "mdbook-linkcheck";
    version = "0.3.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "77d1f0ba4d1e6b86fa18e8853d026d7d76a97eb7eb5eb052ed80901e43b7fc10"; };
    dependencies = {
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "env_logger" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".env_logger."0.6.2" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "log" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.8" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "mdbook" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".mdbook."0.3.1" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "memchr" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".memchr."2.2.0" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "pulldown_cmark" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".pulldown-cmark."0.5.3" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "rayon" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rayon."1.1.0" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "reqwest" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".reqwest."0.9.11" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "structopt" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".structopt."0.2.18" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".mime."0.3.13" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "unicase" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".unicase."2.5.1" { inherit profileName; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".mime_guess."2.0.0-alpha.6" = overridableMkRustCrate (profileName: rec {
    name = "mime_guess";
    version = "2.0.0-alpha.6";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "30de2e4613efcba1ec63d8133f344076952090c122992a903359be5a4f99c3ed"; };
    dependencies = {
      ...
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "phf" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".phf."0.7.24" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "unicase" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".unicase."1.4.2" { inherit profileName; };
    };
    buildDependencies = {
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "phf_codegen" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".phf_codegen."0.7.24" { profileName = "__noProfile"; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "unicase" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".unicase."1.4.2" { profileName = "__noProfile"; };
    };
  });
  ...
  "unknown".miri."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      byteorder = rustPackages."registry+https://github.com/rust-lang/crates.io-index".byteorder."1.3.2" { inherit profileName; };
      ${ if rootFeatures' ? "miri/cargo_metadata" || rootFeatures' ? "miri/cargo_miri" || rootFeatures' ? "miri/default" then "cargo_metadata" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cargo_metadata."0.8.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".native-tls."0.2.3" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if (rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck") && (hostPlatform.parsed.kernel.name == "darwin" || hostPlatform.parsed.kernel.name == "ios") then "lazy_static" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lazy_static."1.3.0" { inherit profileName; };
      ${ if (rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck") && (hostPlatform.parsed.kernel.name == "darwin" || hostPlatform.parsed.kernel.name == "ios") then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.62" { inherit profileName; };
      ...
      ${ if (rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck") && !(hostPlatform.parsed.kernel.name == "windows" || hostPlatform.parsed.kernel.name == "darwin" || hostPlatform.parsed.kernel.name == "ios") then "openssl" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".openssl."0.10.16" { inherit profileName; };
      ...
      ${ if (rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck") && hostPlatform.parsed.kernel.name == "windows" then "schannel" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".schannel."0.1.14" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".net2."0.2.33" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      cfg_if = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."0.1.8" { inherit profileName; };
      ${ if hostPlatform.parsed.kernel.name == "redox" || hostPlatform.isUnix then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.62" { inherit profileName; };
      ${ if hostPlatform.isWindows then "winapi" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".winapi."0.3.6" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".phf."0.7.24" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck") "unicase")
    ];
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".pulldown-cmark."0.6.0" = overridableMkRustCrate (profileName: rec {
    name = "pulldown-cmark";
    version = "0.6.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "85b0ad0d4c1702965ee6bb5b4ff5e71f83850b497d497e9444302987bf9e26a4"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "getopts" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".racer."2.1.27" = overridableMkRustCrate (profileName: rec {
    name = "racer";
    version = "2.1.27";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "dde22b84ab75220015cbd91240222402bf885cbe3a5dc856475771abb82533ae"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.1.0" { inherit profileName; };
      clap = rustPackages."registry+https://github.com/rust-lang/crates.io-index".clap."2.33.0" { inherit profileName; };
      ...
      syntax = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-syntax."583.0.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rayon."1.1.0" = overridableMkRustCrate (profileName: rec {
    name = "rayon";
    version = "1.1.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "a4b0186e22767d5b9738a05eab7c6ac90b15db17e5b5f9bd87976dd7d89a10a4"; };
    dependencies = {
      ...
      either = rustPackages."registry+https://github.com/rust-lang/crates.io-index".either."1.5.0" { inherit profileName; };
      rayon_core = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rayon-core."1.5.0" { inherit profileName; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rayon-core."1.5.0" = overridableMkRustCrate (profileName: rec {
    name = "rayon-core";
    version = "1.5.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "ebbe0df8435ac0c397d467b6cad6d25543d06e8a019ef3f6af3c384597515bd2"; };
    dependencies = {
      crossbeam_deque = rustPackages."registry+https://github.com/rust-lang/crates.io-index".crossbeam-deque."0.6.3" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".reqwest."0.9.11" = overridableMkRustCrate (profileName: rec {
    name = "reqwest";
    version = "0.9.11";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "e542d9f077c126af32536b6aacc75bb7325400eab8cd0743543be5d91660780d"; };
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck") "default")
    ...
    dependencies = {
      ...
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "libflate" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libflate."0.1.25" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "log" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.8" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "mime" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".mime."0.3.13" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "mime_guess" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".mime_guess."2.0.0-alpha.6" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "native_tls" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".native-tls."0.2.3" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "serde" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.99" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "serde_json" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.40" { inherit profileName; };
  ...
  "unknown".rls."1.39.0" = overridableMkRustCrate (profileName: rec {
    name = "rls";
    version = "1.39.0";
    registry = "unknown";
    ...
    dependencies = {
      ...
      racer = rustPackages."registry+https://github.com/rust-lang/crates.io-index".racer."2.1.27" { inherit profileName; };
      rand = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rand."0.6.1" { inherit profileName; };
      rayon = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rayon."1.1.0" { inherit profileName; };
      regex = rustPackages."registry+https://github.com/rust-lang/crates.io-index".regex."1.1.6" { inherit profileName; };
      ...
      rustfmt_nightly = rustPackages."unknown".rustfmt-nightly."1.4.8" { inherit profileName; };
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.99" { inherit profileName; };
      serde_derive = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_derive."1.0.81" { profileName = "__noProfile"; };
      serde_ignored = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_ignored."0.1.0" { inherit profileName; };
      serde_json = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.40" { inherit profileName; };
  ...
  "unknown".rustbook."0.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      clap = rustPackages."registry+https://github.com/rust-lang/crates.io-index".clap."2.33.0" { inherit profileName; };
      failure = rustPackages."registry+https://github.com/rust-lang/crates.io-index".failure."0.1.5" { inherit profileName; };
      mdbook = rustPackages."registry+https://github.com/rust-lang/crates.io-index".mdbook."0.3.1" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "mdbook_linkcheck" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".mdbook-linkcheck."0.3.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-arena."583.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-arena";
    version = "583.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "f59b76d334bd533f3fdc5c651c27678c5e80fac67c6f7da22ba21a58878c55f5"; };
    dependencies = {
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."583.0.0" { inherit profileName; };
      smallvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".smallvec."0.6.10" { inherit profileName; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-graphviz."583.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-graphviz";
    version = "583.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "3e632ef08ca17458acfd46d2ead3d541a1c249586cd5329f5fe333dacfab6142"; };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."583.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_data_structures";
    version = "583.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "e89e2c7be68185418f3cd56af3df8b29007a59a1cebefa63612d055f9bcb1a36"; };
    dependencies = {
      cfg_if = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."0.1.8" { inherit profileName; };
      crossbeam_utils = rustPackages."registry+https://github.com/rust-lang/crates.io-index".crossbeam-utils."0.6.5" { inherit profileName; };
      ...
      graphviz = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-graphviz."583.0.0" { inherit profileName; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-serialize."583.0.0" { inherit profileName; };
      rustc_hash = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-hash."1.0.1" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_errors."583.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_errors";
    version = "583.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "1e47cb380abeb72b01e42b2342d592f7eeea7d536c2f1f0d0e550dc509e46333"; };
    dependencies = {
      ...
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."583.0.0" { inherit profileName; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-serialize."583.0.0" { inherit profileName; };
      syntax_pos = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-syntax_pos."583.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_lexer."583.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_lexer";
    version = "583.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "494cfaf67f49217d67d0774eeecbba61ac89acf478db97ef11f113ed8a959305"; };
    dependencies = {
      unicode_xid = rustPackages."registry+https://github.com/rust-lang/crates.io-index".unicode-xid."0.2.0" { inherit profileName; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."583.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_macros";
    version = "583.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "e2e5d36becc59b4497f9cbd3ae0610081de0207a1d0e95c066369167b14f486f"; };
    dependencies = {
      itertools = rustPackages."registry+https://github.com/rust-lang/crates.io-index".itertools."0.8.0" { inherit profileName; };
      proc_macro2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."0.4.30" { inherit profileName; };
      quote = rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."0.6.12" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_target."583.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-rustc_target";
    version = "583.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "a7bfc5f96dfc3b9f8d5b57884f7f37467ecff6776cd4b8b491a7daece6fdd7c2"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.1.0" { inherit profileName; };
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.8" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."583.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-serialize."583.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-serialize";
    version = "583.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "2bb9ee231cf79eded39c56647499f83d6136ff5c8c0baaa9e21b6febee00f4f6"; };
    dependencies = {
      indexmap = rustPackages."registry+https://github.com/rust-lang/crates.io-index".indexmap."1.0.2" { inherit profileName; };
      smallvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".smallvec."0.6.10" { inherit profileName; };
    };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-syntax."583.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-syntax";
    version = "583.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "b3827fc208814efbde82d613e31d11b4250ce9e8cf8afe4a4d47bbbd099632c9"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.1.0" { inherit profileName; };
      lazy_static = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lazy_static."1.3.0" { inherit profileName; };
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.8" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."583.0.0" { inherit profileName; };
      errors = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_errors."583.0.0" { inherit profileName; };
      rustc_lexer = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_lexer."583.0.0" { inherit profileName; };
      rustc_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."583.0.0" { profileName = "__noProfile"; };
      rustc_target = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_target."583.0.0" { inherit profileName; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-serialize."583.0.0" { inherit profileName; };
      syntax_pos = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-syntax_pos."583.0.0" { inherit profileName; };
      scoped_tls = rustPackages."registry+https://github.com/rust-lang/crates.io-index".scoped-tls."1.0.0" { inherit profileName; };
      smallvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".smallvec."0.6.10" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rustc-ap-syntax_pos."583.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc-ap-syntax_pos";
    version = "583.0.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "930ed81c34f325e512cc315c04d676fa84a373879d5c43bb54054a0522b05213"; };
    dependencies = {
      cfg_if = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."0.1.8" { inherit profileName; };
      arena = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-arena."583.0.0" { inherit profileName; };
      rustc_data_structures = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_data_structures."583.0.0" { inherit profileName; };
      rustc_macros = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-rustc_macros."583.0.0" { profileName = "__noProfile"; };
      rustc_serialize = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-ap-serialize."583.0.0" { inherit profileName; };
      scoped_tls = rustPackages."registry+https://github.com/rust-lang/crates.io-index".scoped-tls."1.0.0" { inherit profileName; };
  ...
  "unknown".rustc_ast_borrowck."0.0.0" = overridableMkRustCrate (profileName: rec {
    name = "rustc_ast_borrowck";
    version = "0.0.0";
    registry = "unknown";
    src = fetchCrateLocal (workspaceSrc + "/src/librustc_ast_borrowck");
    dependencies = {
  ...
  "unknown".rustc_driver."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.8" { inherit profileName; };
      rustc = rustPackages."unknown".rustc."0.0.0" { inherit profileName; };
      rustc_ast_borrowck = rustPackages."unknown".rustc_ast_borrowck."0.0.0" { inherit profileName; };
      rustc_codegen_utils = rustPackages."unknown".rustc_codegen_utils."0.0.0" { inherit profileName; };
      rustc_data_structures = rustPackages."unknown".rustc_data_structures."0.0.0" { inherit profileName; };
      errors = rustPackages."unknown".rustc_errors."0.0.0" { inherit profileName; };
  ...
  "unknown".rustfmt-nightly."1.4.8" = overridableMkRustCrate (profileName: rec {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".security-framework."0.3.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.62" { inherit profileName; };
  ...
  "unknown".std."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      alloc = rustPackages."unknown".alloc."0.0.0" { inherit profileName; };
      backtrace_rs = rustPackages."registry+https://github.com/rust-lang/crates.io-index".backtrace."0.3.37" { inherit profileName; };
      cfg_if = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."0.1.8" { inherit profileName; };
      compiler_builtins = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.18" { inherit profileName; };
      core = rustPackages."unknown".core."0.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".structopt."0.2.18" = overridableMkRustCrate (profileName: rec {
    name = "structopt";
    version = "0.2.18";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "16c2cdbf9cc375f15d1b4141bc48aeef444806655cd0e904207edc8d68d86ed7"; };
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck") "default")
    ];
    dependencies = {
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "clap" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".clap."2.33.0" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "structopt_derive" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".structopt-derive."0.2.18" { profileName = "__noProfile"; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".structopt-derive."0.2.18" = overridableMkRustCrate (profileName: rec {
    name = "structopt-derive";
    version = "0.2.18";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "53010261a84b37689f9ed7d395165029f9cc7abb9f56bbfe86bee2597ed25107"; };
    dependencies = {
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "heck" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".heck."0.3.0" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "proc_macro2" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".proc-macro2."0.4.30" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "quote" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".quote."0.6.12" { inherit profileName; };
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "syn" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".syn."0.15.35" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".term_size."0.3.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if !(hostPlatform.parsed.kernel.name == "windows") then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.62" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".termion."1.5.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if !(hostPlatform.parsed.kernel.name == "redox") then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.62" { inherit profileName; };
      ${ if hostPlatform.parsed.kernel.name == "redox" then "syscall" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".redox_syscall."0.1.43" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".unicase."1.4.2" = overridableMkRustCrate (profileName: rec {
    ...
    buildDependencies = {
      ${ if rootFeatures' ? "rustbook/linkcheck" || rootFeatures' ? "rustbook/mdbook-linkcheck" then "version_check" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".version_check."0.1.5" { profileName = "__noProfile"; };
    };
  });
