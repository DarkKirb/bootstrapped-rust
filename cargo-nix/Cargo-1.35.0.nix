...
in
{
  ...
  workspace = {
    ...
    cargo = rustPackages.unknown.cargo."0.36.0";
    crates-io = rustPackages.unknown.crates-io."0.24.0";
    rustdoc-tool = rustPackages.unknown.rustdoc-tool."0.0.0";
    rls = rustPackages.unknown.rls."1.35.0";
    rls-rustc = rustPackages.unknown.rls-rustc."0.6.0";
    rustfmt-nightly = rustPackages.unknown.rustfmt-nightly."1.2.0";
  ...
  "registry+https://github.com/rust-lang/crates.io-index".aho-corasick."0.6.9" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      memchr = rustPackages."registry+https://github.com/rust-lang/crates.io-index".memchr."2.1.1" { inherit profileName; };
    };
  });
  ...
  "unknown".alloc."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      compiler_builtins = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.9" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".ammonia."1.1.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      lazy_static = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lazy_static."1.2.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".atty."0.2.11" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if hostPlatform.isUnix then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.51" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".backtrace-sys."0.1.27" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "std/backtrace" || rootFeatures' ? "std/backtrace-sys" then "compiler_builtins" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.9" { inherit profileName; };
      libc = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.51" { inherit profileName; };
    ...
    buildDependencies = {
      cc = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.28" { profileName = "__noProfile"; };
    };
  });
  ...
  "unknown".bootstrap."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      cc = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.28" { inherit profileName; };
  ...
  "unknown".cargo."0.36.0" = overridableMkRustCrate (profileName: rec {
    name = "cargo";
    version = "0.36.0";
    registry = "unknown";
    ...
    dependencies = {
      ...
      crates_io = rustPackages."unknown".crates-io."0.24.0" { inherit profileName; };
      crossbeam_utils = rustPackages."registry+https://github.com/rust-lang/crates.io-index".crossbeam-utils."0.6.2" { inherit profileName; };
      ...
      ignore = rustPackages."registry+https://github.com/rust-lang/crates.io-index".ignore."0.4.6" { inherit profileName; };
      ...
      num_cpus = rustPackages."registry+https://github.com/rust-lang/crates.io-index".num_cpus."1.8.0" { inherit profileName; };
      opener = rustPackages."registry+https://github.com/rust-lang/crates.io-index".opener."0.3.2" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".cargo_metadata."0.6.2" = overridableMkRustCrate (profileName: rec {
    ...
    features = builtins.concatLists [
      (lib.optional (rootFeatures' ? "miri/cargo_metadata" || rootFeatures' ? "miri/cargo_miri" || rootFeatures' ? "miri/default") "backtrace")
      (lib.optional (rootFeatures' ? "miri/cargo_metadata" || rootFeatures' ? "miri/cargo_miri" || rootFeatures' ? "miri/default") "default")
    ];
    dependencies = {
      ${ if rootFeatures' ? "miri/cargo_metadata" || rootFeatures' ? "miri/cargo_miri" || rootFeatures' ? "miri/default" then "error_chain" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".error-chain."0.12.0" { inherit profileName; };
      ${ if rootFeatures' ? "miri/cargo_metadata" || rootFeatures' ? "miri/cargo_miri" || rootFeatures' ? "miri/default" then "semver" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".semver."0.9.0" { inherit profileName; };
      ${ if rootFeatures' ? "miri/cargo_metadata" || rootFeatures' ? "miri/cargo_miri" || rootFeatures' ? "miri/default" then "serde" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.82" { inherit profileName; };
      ${ if rootFeatures' ? "miri/cargo_metadata" || rootFeatures' ? "miri/cargo_miri" || rootFeatures' ? "miri/default" then "serde_derive" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_derive."1.0.81" { profileName = "__noProfile"; };
      ${ if rootFeatures' ? "miri/cargo_metadata" || rootFeatures' ? "miri/cargo_miri" || rootFeatures' ? "miri/default" then "serde_json" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.33" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".cc."1.0.28" = overridableMkRustCrate (profileName: rec {
    name = "cc";
    version = "1.0.28";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "bb4a8b715cb4597106ea87c7c84b2f1d452c7492033765df7f32651e66fcf749"; };
  });
  ...
  "unknown".clippy."0.0.212" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      regex = rustPackages."registry+https://github.com/rust-lang/crates.io-index".regex."1.1.0" { inherit profileName; };
    ...
    devDependencies = {
      ...
      compiletest_rs = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiletest_rs."0.3.21" { inherit profileName; };
  ...
  "unknown".clippy_lints."0.0.212" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      regex_syntax = rustPackages."registry+https://github.com/rust-lang/crates.io-index".regex-syntax."0.6.4" { inherit profileName; };
      semver = rustPackages."registry+https://github.com/rust-lang/crates.io-index".semver."0.9.0" { inherit profileName; };
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.82" { inherit profileName; };
      serde_derive = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_derive."1.0.81" { profileName = "__noProfile"; };
      smallvec = rustPackages."registry+https://github.com/rust-lang/crates.io-index".smallvec."0.6.7" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.9" = overridableMkRustCrate (profileName: rec {
    name = "compiler_builtins";
    version = "0.1.9";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "d7de11892d9f9f1bc76d43011c8233d27d58300d629dc9dfb51b6626ef7f6077"; };
    features = builtins.concatLists [
      [ "c" ]
      [ "cc" ]
      [ "compiler-builtins" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".compiletest_rs."0.3.21" = overridableMkRustCrate (profileName: rec {
    name = "compiletest_rs";
    version = "0.3.21";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "17a60483b7d4d1534db7b77458a03d5d8a93a707432a04978dfe87ea43bb61b1"; };
    features = builtins.concatLists [
      [ "norustc" ]
      [ "stable" ]
      [ "tempfile" ]
  ...
  "unknown".crates-io."0.24.0" = overridableMkRustCrate (profileName: rec {
    name = "crates-io";
    version = "0.24.0";
    registry = "unknown";
  ...
  "registry+https://github.com/rust-lang/crates.io-index".crossbeam-channel."0.3.4" = overridableMkRustCrate (profileName: rec {
    name = "crossbeam-channel";
    version = "0.3.4";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "5b2a9ea8f77c7f9efd317a8a5645f515d903a2d86ee14d2337a5facd1bd52c12"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".crossbeam-utils."0.6.2" = overridableMkRustCrate (profileName: rec {
    name = "crossbeam-utils";
    version = "0.6.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "e07fc155212827475223f0bcfae57e945e694fc90950ddf3f6695bbfd5555c72"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "std" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".curl."0.4.19" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if hostPlatform.isUnix && !(hostPlatform.parsed.kernel.name == "darwin") then "openssl_sys" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".openssl-sys."0.9.40" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".directories."1.0.2" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if (rootFeatures' ? "miri/cargo_miri" || rootFeatures' ? "miri/default" || rootFeatures' ? "miri/directories") && hostPlatform.isUnix then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.51" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".dlmalloc."0.1.3" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      compiler_builtins = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.9" { inherit profileName; };
      ${ if hostPlatform.isUnix && !(hostPlatform.parsed.cpu.name == "wasm32") then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.51" { inherit profileName; };
      core = rustPackages."unknown".rustc-std-workspace-core."1.0.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".globset."0.4.2" = overridableMkRustCrate (profileName: rec {
    name = "globset";
    version = "0.4.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "4743617a7464bbda3c8aec8558ff2f9429047e025771037df561d383337ff865"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".ignore."0.4.6" = overridableMkRustCrate (profileName: rec {
    name = "ignore";
    version = "0.4.6";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "ad03ca67dc12474ecd91fdb94d758cbd20cb4e7a78ebe831df26a9b7511e1162"; };
    dependencies = {
      crossbeam_channel = rustPackages."registry+https://github.com/rust-lang/crates.io-index".crossbeam-channel."0.3.4" { inherit profileName; };
      globset = rustPackages."registry+https://github.com/rust-lang/crates.io-index".globset."0.4.2" { inherit profileName; };
      lazy_static = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lazy_static."1.2.0" { inherit profileName; };
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.6" { inherit profileName; };
      memchr = rustPackages."registry+https://github.com/rust-lang/crates.io-index".memchr."2.1.1" { inherit profileName; };
      regex = rustPackages."registry+https://github.com/rust-lang/crates.io-index".regex."1.1.0" { inherit profileName; };
  ...
  "unknown".installer."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      error_chain = rustPackages."registry+https://github.com/rust-lang/crates.io-index".error-chain."0.12.0" { inherit profileName; };
      flate2 = rustPackages."registry+https://github.com/rust-lang/crates.io-index".flate2."1.0.6" { inherit profileName; };
      ${ if hostPlatform.isWindows then "lazy_static" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lazy_static."1.2.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".jemalloc-sys."0.3.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rustc-main/jemalloc" || rootFeatures' ? "rustc-main/jemalloc-sys" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.51" { inherit profileName; };
    };
    buildDependencies = {
      ${ if rootFeatures' ? "rustc-main/jemalloc" || rootFeatures' ? "rustc-main/jemalloc-sys" then "cc" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.28" { profileName = "__noProfile"; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".lazy_static."1.2.0" = overridableMkRustCrate (profileName: rec {
    name = "lazy_static";
    version = "1.2.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "a374c89b9db55895453a74c1e38861d9deec0b01b405a82516e9d5de4820dea1"; };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".libc."0.2.51" = overridableMkRustCrate (profileName: rec {
    name = "libc";
    version = "0.2.51";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "bedcc7a809076656486ffe045abeeac163da1b558e963a31e29fbfbeba916917"; };
    features = builtins.concatLists [
      [ "align" ]
      [ "default" ]
      [ "rustc-dep-of-std" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".libgit2-sys."0.7.11" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      libz_sys = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libz-sys."1.0.25" { inherit profileName; };
      ${ if hostPlatform.isUnix then "openssl_sys" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".openssl-sys."0.9.40" { inherit profileName; };
    };
    buildDependencies = {
      cc = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.28" { profileName = "__noProfile"; };
      pkg_config = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".pkg-config."0.3.14" { profileName = "__noProfile"; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".lsp-types."0.55.4" = overridableMkRustCrate (profileName: rec {
    name = "lsp-types";
    version = "0.55.4";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "6392b5843615b8a2adeebe87b83fdd29567c0870baba3407a67e6dbfee4712f8"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.0.4" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".memchr."2.1.1" = overridableMkRustCrate (profileName: rec {
    name = "memchr";
    version = "2.1.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "0a3eb002f0535929f1199681417029ebea04aadc0c7a4224b46be99c7f5d6a16"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "libc" ]
      [ "use_std" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".minifier."0.0.29" = overridableMkRustCrate (profileName: rec {
    name = "minifier";
    version = "0.0.29";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "1f4950cb2617b1933e2da0446e864dfe0d6a22c22ff72297996c46e6a63b210b"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".net2."0.2.33" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      cfg_if = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cfg-if."0.1.6" { inherit profileName; };
      ${ if hostPlatform.parsed.kernel.name == "redox" || hostPlatform.isUnix then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.51" { inherit profileName; };
      ${ if hostPlatform.isWindows then "winapi" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".winapi."0.3.6" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".opener."0.3.2" = overridableMkRustCrate (profileName: rec {
    name = "opener";
    version = "0.3.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "04b1d6b086d9b3009550f9b6f81b10ad9428cf14f404b8e1a3a06f6f012c8ec9"; };
    dependencies = {
      failure = rustPackages."registry+https://github.com/rust-lang/crates.io-index".failure."0.1.5" { inherit profileName; };
      failure_derive = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".failure_derive."0.1.5" { profileName = "__noProfile"; };
      ${ if hostPlatform.isWindows then "winapi" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".winapi."0.3.6" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".openssl."0.10.16" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      lazy_static = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lazy_static."1.2.0" { inherit profileName; };
      libc = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.51" { inherit profileName; };
      openssl_sys = rustPackages."registry+https://github.com/rust-lang/crates.io-index".openssl-sys."0.9.40" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".openssl-src."111.1.0+1.1.1a" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "cargo/vendored-openssl" then "cc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.28" { inherit profileName; };
    };
  });
  
  "registry+https://github.com/rust-lang/crates.io-index".openssl-sys."0.9.40" = overridableMkRustCrate (profileName: rec {
    name = "openssl-sys";
    version = "0.9.40";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "1bb974e77de925ef426b6bc82fce15fd45bdcbeb5728bffcfc7cdeeb7ce1c2d6"; };
    features = builtins.concatLists [
  ...
  "registry+https://github.com/rust-lang/crates.io-index".polonius-engine."0.6.2" = overridableMkRustCrate (profileName: rec {
    name = "polonius-engine";
    version = "0.6.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "2490c396085801abf88df91758bad806b0890354f0875d624e62ecf0579a8145"; };
    dependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".racer."2.1.21" = overridableMkRustCrate (profileName: rec {
    name = "racer";
    version = "2.1.21";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "37c88638777cc178684cf648ca0e1dad56646ce105b8593dfe665c436300adc3"; };
    dependencies = {
      bitflags = rustPackages."registry+https://github.com/rust-lang/crates.io-index".bitflags."1.0.4" { inherit profileName; };
      clap = rustPackages."registry+https://github.com/rust-lang/crates.io-index".clap."2.32.0" { inherit profileName; };
      ...
      lazy_static = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lazy_static."1.2.0" { inherit profileName; };
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.6" { inherit profileName; };
      rls_span = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rls-span."0.4.1" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".regex."1.1.0" = overridableMkRustCrate (profileName: rec {
    name = "regex";
    version = "1.1.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "37e7cbbd370869ce2e8dff25c7018702d10b21a20ef7135316f8daecd6c25b7f"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "use_std" ]
    ];
  ...
  "registry+https://github.com/rust-lang/crates.io-index".regex-syntax."0.6.4" = overridableMkRustCrate (profileName: rec {
    name = "regex-syntax";
    version = "0.6.4";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "4e47a2ed29da7a9e1960e1639e7a982e6edc6d49be308a3b02daf511504a16d1"; };
    dependencies = {
      ucd_util = rustPackages."registry+https://github.com/rust-lang/crates.io-index".ucd-util."0.1.3" { inherit profileName; };
    };
  });
  ...
  "unknown".rls."1.35.0" = overridableMkRustCrate (profileName: rec {
    name = "rls";
    version = "1.35.0";
    registry = "unknown";
    ...
    dependencies = {
      cargo = rustPackages."unknown".cargo."0.36.0" { inherit profileName; };
      cargo_metadata = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cargo_metadata."0.7.1" { inherit profileName; };
      ...
      lazy_static = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lazy_static."1.2.0" { inherit profileName; };
      log = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.6" { inherit profileName; };
      lsp_types = rustPackages."registry+https://github.com/rust-lang/crates.io-index".lsp-types."0.55.4" { inherit profileName; };
      num_cpus = rustPackages."registry+https://github.com/rust-lang/crates.io-index".num_cpus."1.8.0" { inherit profileName; };
      ordslice = rustPackages."registry+https://github.com/rust-lang/crates.io-index".ordslice."0.3.0" { inherit profileName; };
      racer = rustPackages."registry+https://github.com/rust-lang/crates.io-index".racer."2.1.21" { inherit profileName; };
      rand = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rand."0.6.1" { inherit profileName; };
      rayon = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rayon."1.0.1" { inherit profileName; };
      regex = rustPackages."registry+https://github.com/rust-lang/crates.io-index".regex."1.1.0" { inherit profileName; };
      rls_analysis = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rls-analysis."0.16.12" { inherit profileName; };
      rls_blacklist = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rls-blacklist."0.1.3" { inherit profileName; };
      rls_data = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rls-data."0.18.2" { inherit profileName; };
      ...
      rustfmt_nightly = rustPackages."unknown".rustfmt-nightly."1.2.0" { inherit profileName; };
      serde = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde."1.0.82" { inherit profileName; };
      serde_derive = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_derive."1.0.81" { profileName = "__noProfile"; };
      serde_ignored = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_ignored."0.0.4" { inherit profileName; };
      serde_json = rustPackages."registry+https://github.com/rust-lang/crates.io-index".serde_json."1.0.33" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rls-analysis."0.16.12" = overridableMkRustCrate (profileName: rec {
    name = "rls-analysis";
    version = "0.16.12";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "ae18d8ad01dec3b2014f4d7ae3c607d7adbcff79e5d3b48ea42ea71c10d43a71"; };
    dependencies = {
      derive_new = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".derive-new."0.5.6" { profileName = "__noProfile"; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rls-data."0.18.2" = overridableMkRustCrate (profileName: rec {
    name = "rls-data";
    version = "0.18.2";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "5f80b84551b32e26affaf7f12374913b5061730c0dcd185d9e8fa5a15e36e65c"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "rustc-serialize" ]
      [ "serde" ]
  ...
  "registry+https://github.com/rust-lang/crates.io-index".rls-span."0.4.1" = overridableMkRustCrate (profileName: rec {
    name = "rls-span";
    version = "0.4.1";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "33d66f1d6c6ccd5c98029f162544131698f6ebb61d8c697681cac409dcd08805"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "rustc-serialize" ]
      [ "serde" ]
  ...
  "unknown".rustc."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      num_cpus = rustPackages."registry+https://github.com/rust-lang/crates.io-index".num_cpus."1.8.0" { inherit profileName; };
      parking_lot = rustPackages."registry+https://github.com/rust-lang/crates.io-index".parking_lot."0.7.1" { inherit profileName; };
      polonius_engine = rustPackages."registry+https://github.com/rust-lang/crates.io-index".polonius-engine."0.6.2" { inherit profileName; };
      rustc_rayon = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-rayon."0.1.2" { inherit profileName; };
  ...
  "unknown".rustdoc."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      minifier = rustPackages."registry+https://github.com/rust-lang/crates.io-index".minifier."0.0.29" { inherit profileName; };
      parking_lot = rustPackages."registry+https://github.com/rust-lang/crates.io-index".parking_lot."0.7.1" { inherit profileName; };
      pulldown_cmark = rustPackages."registry+https://github.com/rust-lang/crates.io-index".pulldown-cmark."0.1.2" { inherit profileName; };
      tempfile = rustPackages."registry+https://github.com/rust-lang/crates.io-index".tempfile."3.0.5" { inherit profileName; };
    };
  ...
  "unknown".rustfmt-nightly."1.2.0" = overridableMkRustCrate (profileName: rec {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".socket2."0.3.8" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      ${ if hostPlatform.isUnix || hostPlatform.parsed.kernel.name == "redox" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.51" { inherit profileName; };
      ${ if hostPlatform.parsed.kernel.name == "redox" then "syscall" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".redox_syscall."0.1.43" { inherit profileName; };
      ${ if hostPlatform.isWindows then "winapi" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".winapi."0.3.6" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".termion."1.5.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if !(hostPlatform.parsed.kernel.name == "redox") then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.51" { inherit profileName; };
      ${ if hostPlatform.parsed.kernel.name == "redox" then "syscall" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".redox_syscall."0.1.43" { inherit profileName; };
  ...
  "unknown".unwind."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    buildDependencies = {
      ${ if rootFeatures' ? "std/llvm-libunwind" || rootFeatures' ? "unwind/cc" || rootFeatures' ? "unwind/llvm-libunwind" then "cc" else null } = buildRustPackages."registry+https://github.com/rust-lang/crates.io-index".cc."1.0.28" { profileName = "__noProfile"; };
    };
  });
