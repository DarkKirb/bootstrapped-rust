...
in
{
  ...
  workspace = {
    ...
    clippy = rustPackages.unknown.clippy."0.1.55";
    clippy_lints = rustPackages.unknown.clippy_lints."0.1.55";
    clippy_utils = rustPackages.unknown.clippy_utils."0.1.55";
    ...
    cargo = rustPackages.unknown.cargo."0.56.0";
  ...
  "unknown".cargo."0.56.0" = overridableMkRustCrate (profileName: rec {
    name = "cargo";
    version = "0.56.0";
    registry = "unknown";
    ...
    dependencies = {
      ...
      curl_sys = rustPackages."registry+https://github.com/rust-lang/crates.io-index".curl-sys."0.4.45+curl-7.78.0" { inherit profileName; };
  ...
  "unknown".clippy."0.1.55" = overridableMkRustCrate (profileName: rec {
    name = "clippy";
    version = "0.1.55";
    registry = "unknown";
    ...
    dependencies = {
      clippy_lints = rustPackages."unknown".clippy_lints."0.1.55" { inherit profileName; };
  ...
  "unknown".clippy_lints."0.1.55" = overridableMkRustCrate (profileName: rec {
    name = "clippy_lints";
    version = "0.1.55";
    registry = "unknown";
    ...
    dependencies = {
      cargo_metadata = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cargo_metadata."0.12.0" { inherit profileName; };
      clippy_utils = rustPackages."unknown".clippy_utils."0.1.55" { inherit profileName; };
  ...
  "unknown".clippy_utils."0.1.55" = overridableMkRustCrate (profileName: rec {
    name = "clippy_utils";
    version = "0.1.55";
    registry = "unknown";
  ...
  "registry+https://github.com/rust-lang/crates.io-index".curl-sys."0.4.45+curl-7.78.0" = overridableMkRustCrate (profileName: rec {
    name = "curl-sys";
    version = "0.4.45+curl-7.78.0";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "de9e5a72b1c744eb5dd20b2be4d7eb84625070bb5c4ab9b347b70464ab1e62eb"; };
    features = builtins.concatLists [
      [ "default" ]
      [ "http2" ]
      [ "libnghttp2-sys" ]
  ...
  "unknown".rls."1.41.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      anyhow = rustPackages."registry+https://github.com/rust-lang/crates.io-index".anyhow."1.0.34" { inherit profileName; };
      cargo = rustPackages."unknown".cargo."0.56.0" { inherit profileName; };
      cargo_util = rustPackages."unknown".cargo-util."0.1.1" { inherit profileName; };
      cargo_metadata = rustPackages."registry+https://github.com/rust-lang/crates.io-index".cargo_metadata."0.12.0" { inherit profileName; };
      ${ if rootFeatures' ? "rls/clippy" || rootFeatures' ? "rls/clippy_lints" then "clippy_lints" else null } = rustPackages."unknown".clippy_lints."0.1.55" { inherit profileName; };
  ...
  "unknown".rls-rustc."0.6.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rls/clippy" || rootFeatures' ? "rls-rustc/clippy" || rootFeatures' ? "rls-rustc/clippy_lints" then "clippy_lints" else null } = rustPackages."unknown".clippy_lints."0.1.55" { inherit profileName; };
      env_logger = rustPackages."registry+https://github.com/rust-lang/crates.io-index".env_logger."0.7.1" { inherit profileName; };
