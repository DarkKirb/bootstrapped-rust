...
in
{
  ...
  workspace = {
    ...
    clippy = rustPackages.unknown.clippy."0.1.58";
    clippy_lints = rustPackages.unknown.clippy_lints."0.1.58";
    clippy_utils = rustPackages.unknown.clippy_utils."0.1.58";
    ...
    cargo = rustPackages.unknown.cargo."0.59.0";
  ...
  "registry+https://github.com/rust-lang/crates.io-index".addr2line."0.16.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "std/backtrace" || rootFeatures' ? "test/backtrace" then "compiler_builtins" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.53" { inherit profileName; };
  ...
  "unknown".alloc."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      compiler_builtins = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.53" { inherit profileName; };
  ...
  "unknown".cargo."0.59.0" = overridableMkRustCrate (profileName: rec {
    name = "cargo";
    version = "0.59.0";
    registry = "unknown";
  ...
  "unknown".clippy."0.1.58" = overridableMkRustCrate (profileName: rec {
    name = "clippy";
    version = "0.1.58";
    registry = "unknown";
    ...
    dependencies = {
      clippy_lints = rustPackages."unknown".clippy_lints."0.1.58" { inherit profileName; };
    ...
    devDependencies = {
      ...
      clippy_utils = rustPackages."unknown".clippy_utils."0.1.58" { inherit profileName; };
  ...
  "unknown".clippy_lints."0.1.58" = overridableMkRustCrate (profileName: rec {
    name = "clippy_lints";
    version = "0.1.58";
    registry = "unknown";
  ...
  "unknown".clippy_utils."0.1.58" = overridableMkRustCrate (profileName: rec {
    name = "clippy_utils";
    version = "0.1.58";
    registry = "unknown";
  ...
  "registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.53" = overridableMkRustCrate (profileName: rec {
    name = "compiler_builtins";
    version = "0.1.53";
    registry = "registry+https://github.com/rust-lang/crates.io-index";
    src = fetchCratesIo { inherit name version; sha256 = "2467ff455350a4df7d02f1ed1449d0279605a763de5d586dcf6aa7d732508bcb"; };
    features = builtins.concatLists [
  ...
  "registry+https://github.com/rust-lang/crates.io-index".dlmalloc."0.2.3" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      compiler_builtins = rustPackages."registry+https://github.com/rust-lang/crates.io-index".compiler_builtins."0.1.53" { inherit profileName; };
      ${ if hostPlatform.isUnix && !(hostPlatform.parsed.cpu.name == "wasm32") then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.106" { inherit profileName; };
      core = rustPackages."unknown".rustc-std-workspace-core."1.99.0" { inherit profileName; };
    };
  });
  ...
  "registry+https://github.com/rust-lang/crates.io-index".parity-tokio-ipc."0.9.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "futures" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".futures."0.3.12" { inherit profileName; };
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.106" { inherit profileName; };
      ${ if rootFeatures' ? "rls/default" || rootFeatures' ? "rls/ipc" || rootFeatures' ? "rls-ipc/client" || rootFeatures' ? "rls-ipc/jsonrpc-ipc-server" || rootFeatures' ? "rls-ipc/server" || rootFeatures' ? "rls-rustc/ipc" then "log" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".log."0.4.14" { inherit profileName; };
  ...
  "unknown".rls."1.41.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      anyhow = rustPackages."registry+https://github.com/rust-lang/crates.io-index".anyhow."1.0.34" { inherit profileName; };
      cargo = rustPackages."unknown".cargo."0.59.0" { inherit profileName; };
      cargo_util = rustPackages."unknown".cargo-util."0.1.1" { inherit profileName; };
      ...
      ${ if rootFeatures' ? "rls/clippy" || rootFeatures' ? "rls/clippy_lints" then "clippy_lints" else null } = rustPackages."unknown".clippy_lints."0.1.58" { inherit profileName; };
  ...
  "unknown".rls-rustc."0.6.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rls/clippy" || rootFeatures' ? "rls-rustc/clippy" || rootFeatures' ? "rls-rustc/clippy_lints" then "clippy_lints" else null } = rustPackages."unknown".clippy_lints."0.1.58" { inherit profileName; };
      env_logger = rustPackages."registry+https://github.com/rust-lang/crates.io-index".env_logger."0.7.1" { inherit profileName; };
  ...
  "unknown".rustc_middle."0.0.0" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ...
      rustc_rayon = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-rayon."0.3.1" { inherit profileName; };
      rustc_rayon_core = rustPackages."registry+https://github.com/rust-lang/crates.io-index".rustc-rayon-core."0.3.1" { inherit profileName; };
      rustc_apfloat = rustPackages."unknown".rustc_apfloat."0.0.0" { inherit profileName; };
      rustc_arena = rustPackages."unknown".rustc_arena."0.0.0" { inherit profileName; };
      rustc_ast = rustPackages."unknown".rustc_ast."0.0.0" { inherit profileName; };
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tikv-jemalloc-sys."0.4.1+5.2.1-patched" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rustc-main/jemalloc" || rootFeatures' ? "rustc-main/tikv-jemalloc-sys" || rootFeatures' ? "rustc-main/tikv-jemallocator" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.106" { inherit profileName; };
    };
    buildDependencies = {
  ...
  "registry+https://github.com/rust-lang/crates.io-index".tikv-jemallocator."0.4.1" = overridableMkRustCrate (profileName: rec {
    ...
    dependencies = {
      ${ if rootFeatures' ? "rustc-main/jemalloc" || rootFeatures' ? "rustc-main/tikv-jemallocator" then "libc" else null } = rustPackages."registry+https://github.com/rust-lang/crates.io-index".libc."0.2.106" { inherit profileName; };
